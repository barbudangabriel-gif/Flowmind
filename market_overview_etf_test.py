...
class MarketOverviewETFTester:
 ...
 print(
 f" Price outside ETF range: ${price:.2f} (expected: ${min_price}-${max_price})"
 )
 ...
 print(" May be using different data source")
 ...
 print(f" Partial enhanced fields: {', '.join(fields_present)}")
 else:
 ...
 print(f" Using index symbol instead of ETF: {underlying_symbol}")
 else:
 ...
 print(" Note doesn't clearly mention ETF alternatives")
 ...
 print(" Some minor issues with enhanced features")
 elif success_rate >= 50:
 print(
 "\n VERDICT: PARTIAL - Market Overview ETF integration partially working"
 )
 print(" Some ETF features working but significant gaps remain")
 else:
 print(
