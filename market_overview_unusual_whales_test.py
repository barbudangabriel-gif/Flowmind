...
class MarketOverviewUnusualWhalesTest:
 ...
 print(
 f" Price outside expected range for {underlying_symbol}: ${price:.2f} (expected: ${min_price}-${max_price})"
 )
 else:
 ...
 verdict = (
 " PARTIAL - Market Overview working but significant issues detected"
 )
 verdict_details = (
