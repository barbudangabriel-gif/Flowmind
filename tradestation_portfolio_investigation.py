...
class TradeStationPortfolioInvestigator:
 ...
 self.log_finding(
 "TS_POSITIONS",
 f"TradeStation Direct API shows ${total_market_value:,.2f} total portfolio value",
 "INFO",
 )
 self.log_finding(
 "TS_POSITIONS",
 ...
 self.log_finding(
 "PM_SERVICE",
 f"Failed to access Portfolio Management Service: {result['error']}",
 "CRITICAL",
 )
 return None
 ...
 self.log_finding(
 "PM_SERVICE",
 f"Portfolio Management Service returned status {result['status_code']}",
 "CRITICAL",
 )
 return None
 ...
 self.log_finding(
 "PM_SERVICE",
 "Successfully retrieved Portfolio Management Service data",
 "SUCCESS",
 )
 ...
 self.log_finding(
 "PM_SERVICE",
 f"Portfolio Management Service shows ${pm_total_value:,.2f} total portfolio value",
 "INFO",
 )
 self.log_finding(
 "PM_SERVICE",
 f"Portfolio Management shows {len(positions)} total positions",
 "INFO",
 )
 ...
 self.log_finding(
 "PM_SERVICE",
 "No obvious mock data indicators detected in Portfolio Management Service",
 "SUCCESS",
 )
 ...
 self.log_finding(
 "PM_SERVICE",
 f"Found user-reported 'fake' symbols in Portfolio Management: {found_fake_symbols}",
 "CRITICAL",
 )
 else:
 self.log_finding(
 "PM_SERVICE",
 "User-reported 'fake' symbols not found in Portfolio Management Service",
 "INFO",
 )
 ...
 self.log_finding(
 "COMPARISON",
 f"Portfolio values are consistent (difference: ${value_difference:,.2f})",
 "SUCCESS",
 )
 ...
 self.log_finding(
 "COMPARISON",
 f"TradeStation has {len(ts_only_symbols)} symbols not in Portfolio Management",
 "WARNING",
 )

 if pm_only_symbols:
 print(
 f" Portfolio Mgmt exclusive: {list(pm_only_symbols)[:10]}"
 ) # Show first 10
 self.log_finding(
 "COMPARISON",
 f"Portfolio Management has {len(pm_only_symbols)} symbols not in TradeStation",
 "WARNING",
 )
 ...
 self.log_finding(
 "COMPARISON",
 f"Portfolio Management Service shows more mock data indicators ({pm_suspicious} vs {ts_suspicious})",
 "CRITICAL",
 )
 ...
 print(
 " 1. 🚨 URGENT: Fix Portfolio Management Service to use real TradeStation data"
 )
 print(
 " 2. Investigate why Portfolio Management Service shows different values"
 )
 print(
 " 3. Implement data validation between TradeStation API and Portfolio Management"
 )
 ...
 print(
 " 6. Ensure Portfolio Management Service uses authenticated TradeStation data"
 )
