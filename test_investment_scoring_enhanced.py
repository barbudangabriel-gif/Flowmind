...
class EnhancedInvestmentScoringTester:
    ...
    def test_enhanced_investment_scoring_agent(self):
        ...
        if nvda_score >= 65 and discount_score >= 60:
            ...
            print(
                "   ⚠️  NVDA shows moderate score but may not fully capture discount opportunity"
            )
            nvda_success = True
        else:
            print(
        ...
        if "DISCOUNT" in nvda_recommendation or "BUY" in nvda_recommendation:
            ...
            print(
                f"   ⚠️  NVDA recommendation may not reflect discount opportunity: {nvda_recommendation}"
            )
        ...
        if aapl_score <= 55 and aapl_premium_penalty <= 60:
            ...
            print(
                "   ⚠️  AAPL shows moderate penalty but may not fully capture premium risk"
            )
            aapl_success = True
        else:
            print(
        ...
        if (
            ...
            print(
                f"   ⚠️  AAPL recommendation may not reflect premium risk: {aapl_recommendation}"
            )
        ...
        if 45 <= msft_score <= 65:
            ...
            print(
                f"   ⚠️  MSFT score may be outside expected neutral range: {msft_score}"
            )
        ...
        if discount_found >= 3 and premium_found >= 3 and risk_found >= 2:
            ...
            print("   ⚠️  Methodology mentions discount/premium but may lack detail")
            methodology_success = True
        else:
            print(
        ...
        if nvda_score >= msft_score and msft_score >= aapl_score:
            ...
            print("   ⚠️  NVDA > AAPL as expected, but MSFT ordering may vary")
            comparative_success = True
        else:
