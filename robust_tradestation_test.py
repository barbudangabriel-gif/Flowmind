...
class RobustTradeStationTester:
    ...
    def test_health_check_endpoints(self):
        ...
        if success1:
            ...
            if not robust_available:
                print(
                    "   ⚠️  WARNING: Robust TradeStation system not available - will test legacy system"
                )
        ...
        if success2:
            ...
            print(
                "   ⚠️  Robust system health endpoint not accessible - testing legacy system"
            )
            return success1
    ...
    def test_token_management_endpoints(self):
        ...
        print("=" * 80)
        print(
            "   ⚠️  NOTE: Testing legacy system due to routing conflicts with robust system"
        )
