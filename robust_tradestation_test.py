...
class RobustTradeStationTester:
    ...
    def test_robust_features(self):
        ...
        print("=" * 80)
        print("   ⚠️  NOTE: Testing available robust features through legacy endpoints")
        
        # Test 1: Verify robust system is available (health check)
        success1, health_check = self.run_test(
            "Robust System Health Check", 
            "GET", 
            "auth/tradestation/health", 
            200
        )
        ...
        if success4:
            ...
            if api_stable:
                ...
                print("   ⚠️  TradeStation API integration may be unstable")
        ...
        if error_handling:
            print("   ✅ Error handling working correctly (404 for non-existent endpoint)")
        else:
            print("   ⚠️  Error handling may not be working as expected")
        
        return all([robust_available, refresh_working, concurrent_handling, api_stable, error_handling])
