...
class TradeStationAuthTester:
 ...
 print(f" Environment not LIVE: {environment}")
 ...
 print(f" Base URL unexpected: {base_url}")
 ...
 print(" Callback returned error (expected for mock code)")
 ...
 print(f" Unexpected error handling (Status: {response_code})")
