...
def test_options_chain_endpoint():
 ...
 print(" Quality field not found in strike data")
...
def test_options_expirations_endpoint():
 ...
 print(f" Date format may be non-standard: {expirations[0]}")

 else:
 print(
 f" 'expirations' field missing. Response keys: {list(data.keys())}"
 )
...
def test_error_handling():
 ...
 print(" Unexpected response for empty payload")
