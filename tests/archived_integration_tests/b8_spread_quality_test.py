...
def test_b8_spread_quality_meter():
 ...
 print(
 f" {strategy.get('label')}: Slippage ${slippage} vs expected ${expected_slippage:.2f}"
 )
 ...
 print(
 f" Questionable market data: Bid=${bid}, Ask=${ask}, Mid=${mid}"
 )
 ...
 print(" B8 SPREAD QUALITY METER BACKEND: GOOD - Minor Issues")
 return True
 else:
