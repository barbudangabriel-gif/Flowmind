#!/usr/bin/env python3
"""
TradeStation Mindfolio Values Verification Test
==============================================

This test verifies the correct TradeStation mindfolio values by testing specific endpoints
...
2. GET `/api/tradestation/accounts/11775499/positions` - Get exact position values and total mindfolio value
3. GET `/api/mindfolio-management/mindfolios/tradestation-main/positions` - Compare mindfolio management service values with direct TradeStation API
...
class TradeStationMindfolioVerificationTester:
 ...
 self.mindfolio_data["accounts"] = accounts_data
 ...
 print(
 " FOCUS: Individual position values, total mindfolio calculation, P&L accuracy"
 )
 ...
 self.mindfolio_data["tradestation_positions"] = positions_data
 ...
 # Check for mindfolio summary in response
 mindfolio_summary = positions_data.get("mindfolio_summary", {})
 if mindfolio_summary:
 print("\n MINDFOLIO SUMMARY FROM API:")
 print("-" * 60)

 summary_total_value = mindfolio_summary.get("total_value", 0)
 summary_total_pnl = mindfolio_summary.get("total_pnl", 0)
 summary_pnl_percent = mindfolio_summary.get("total_pnl_percent", 0)
 ...
 "mindfolio_summary": mindfolio_summary,
 "sample_positions": position_details[:10],
 }

 def test_mindfolio_management_positions(self) -> Dict[str, Any]:
 """Test GET /api/mindfolio-management/mindfolios/tradestation-main/positions"""
 print("\n" + "=" * 80)
 print("🔄 PHASE 3: Mindfolio Management Service Verification")
 print("=" * 80)
 print(
 " OBJECTIVE: Compare Mindfolio Management Service values with direct TradeStation API"
 )
 print(
 " ENDPOINT: GET /api/mindfolio-management/mindfolios/tradestation-main/positions"
 )
 print(" FOCUS: Value comparison, data consistency, integration accuracy")

 success, response_data = self.make_request(
 "GET", "mindfolio-management/mindfolios/tradestation-main/positions"
 )

 if not success:
 self.log_test(
 "Mindfolio Management API",
 "FAIL",
 f"Failed to fetch mindfolio management data: {response_data.get('error', 'Unknown error')}",
 )
 return {"success": False, "positions": [], "error": response_data}

 # Store mindfolio management data
 pm_data = response_data
 self.mindfolio_data["mindfolio_management"] = pm_data

 # Verify response structure
 if not isinstance(pm_data, dict):
 self.log_test(
 "Mindfolio Management Response Structure",
 "FAIL",
 ...
 pm_summary = pm_data.get("mindfolio_summary", {})

 if not pm_positions:
 self.log_test(
 "Mindfolio Management Positions",
 "FAIL",
 ...
 # Analyze Mindfolio Management data
 print("\n MINDFOLIO MANAGEMENT ANALYSIS:")
 print("-" * 60)
 ...
 print("\n SAMPLE MINDFOLIO MANAGEMENT POSITIONS:")
 print("-" * 60)
 ...
 print("\n MINDFOLIO MANAGEMENT CALCULATED TOTALS:")
 ...
 def compare_mindfolio_values(self, ts_data: Dict, pm_data: Dict) -> Dict[str, Any]:
 """Compare values between TradeStation direct API and Mindfolio Management Service"""
 print("\n" + "=" * 80)
 print("⚖️ PHASE 4: Mindfolio Values Comparison & Discrepancy Analysis")
 print("=" * 80)
 print(
 " OBJECTIVE: Identify discrepancies between TradeStation API and Mindfolio Management Service"
 )
 ...
 print(f" Mindfolio Management Value: ${pm_total_value:,.2f}")
 ...
 print(f" Mindfolio Mgmt vs Reported: ${pm_vs_reported:+,.2f}")
 ...
 closer_to_reported = "Mindfolio Management"
 self.log_test(
 "Accuracy vs Reported Value",
 "INFO",
 f"Mindfolio Management (${pm_total_value:,.2f}) is closer to reported value",
 )
 else:
 ...
 print(
 " Both TradeStation API and Mindfolio Management Service show consistent values"
 )
 if ts_vs_reported > 1000: # More than $1000 difference
 print(
 f" However, both differ significantly from user reported value (${reported_value:,.2f})"
 )
 print(
 ...
 print(
 " 🔧 Fix Mindfolio Management Service to match TradeStation API values"
 )
 elif closer_to_reported == "Mindfolio Management":
 print(" Recommendation: Verify Mindfolio Management calculations")
 print(" 🔧 Check if Mindfolio Management has more recent data")
 ...
 print("=" * 80)
 print(" OBJECTIVE: TradeStation Mindfolio Values Verification")
 ...
 print(
 f" Mindfolio Management API: {pm_result.get('total_positions', 0)} positions"
 )
 print(
 ...
 print(" Mindfolio Management API: Failed")
 ...
 print(f" Mindfolio Management Value: ${pm_value:,.2f}")
 ...
 print(
 f" - Mindfolio Management: ${comparison_result.get('pm_vs_reported', 0):+,.2f}"
 )
 ...
 print(" • Different mindfolio view (e.g., including cash)")
 elif abs(comparison_result.get("value_difference", 0)) > 1000:
 print("\n ROOT CAUSE ANALYSIS:")
 print(
 " - Significant difference between TradeStation API and Mindfolio Management"
 )
 print(" - Mindfolio Management Service may have calculation errors")
 ...
 elif closer_source == "Mindfolio Management":
 print(" 1. Verify Mindfolio Management calculations are correct")
 print(" 2. Investigate why TradeStation API differs")
 print(" 3. Consider using Mindfolio Management values if verified")
 else:
 ...
 print(" 6. Add discrepancy alerts for large differences")
 ...
 print(
 " PARTIAL SUCCESS: APIs are working but show different values"
 )
 ...
 # True Values Summary
 print("\n TRUE MINDFOLIO VALUES (Best Available):")
 print("-" * 60)
 ...
 print(
 f" Verified Mindfolio Value: ${ts_result.get('total_market_value', 0):,.2f}"
 )
 print(
 ...
 print(
 f" Mindfolio Mgmt Value: ${pm_result.get('summary_total_value', 0):,.2f}"
 )
 print(" Confidence: Medium (sources disagree)")
 ...
 print(
 f" Mindfolio Mgmt P&L: ${pm_result.get('summary_total_pnl', 0):+,.2f}"
 )
 print(" Confidence: Low (fallback source only)")
 else:
 print(" Unable to determine true mindfolio values")
 print(" 🚨 Critical: All data sources failed")

 def run_comprehensive_test(self):
 """Run the complete TradeStation mindfolio verification test"""
 print("🏛️ TRADESTATION MINDFOLIO VALUES VERIFICATION TEST")
 print("=" * 80)
 print(" OBJECTIVE: Verify correct TradeStation mindfolio values")
 print(" USER ISSUE: Values displayed ($790,174) reported as not correct")
 print(" TESTING: Direct TradeStation API vs Mindfolio Management Service")
 ...
 print(
 "\n Skipping TradeStation positions test - account verification failed"
 )
 ts_result = {"success": False, "error": "Account verification failed"}

 # Phase 3: Test Mindfolio Management Service
 pm_result = self.test_mindfolio_management_positions()

 # Phase 4: Compare Values
 if ts_result.get("success") and pm_result.get("success"):
 comparison_result = self.compare_mindfolio_values(ts_result, pm_result)
 else:
 print("\n Skipping comparison - insufficient data from APIs")
 comparison_result = {
 "success": False,
 ...
 "mindfolio_management": pm_result,
...
def main():
 """Main function to run the TradeStation mindfolio verification test"""
 print("Starting TradeStation Mindfolio Values Verification Test...")

 tester = TradeStationMindfolioVerificationTester()
