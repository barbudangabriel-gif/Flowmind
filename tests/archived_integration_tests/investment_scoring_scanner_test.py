...
class InvestmentScoringPriceInvestigator:
 ...
 print(" UNKNOWN: Unexpected price format")
 self.log_issue(
 ...
 print(" No price field in top_5_stocks")
 ...
 print(" No direct price fields found in investment score response")
 print(
 ...
 print(" No stocks processed yet, scan might still be running")
 return False
