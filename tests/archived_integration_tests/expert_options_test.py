...
class ExpertOptionsAPITester:
 ...
 print("=" * 80)
 print(
 " OBJECTIVE: Test all Expert Options endpoints for AI-powered strategies"
 )
 print(" ENDPOINTS TO TEST:")
 print(
 " 1. GET /api/expert-options/strategies/SPY - All strategy recommendations"
 )
 ...
 print(
 f" Generated {total_strategies} strategy recommendations for {symbol}"
 )
 ...
 print(" Complete strategy structure")
 ...
 print(
 f" Leg {j+1}: {action} {option_type} @ ${strike} (${premium} premium)"
 )
 ...
 missing_strategies = [
 s for s in expected_strategies if s not in found_strategies
 ]
 if missing_strategies:
 print(f" Missing strategies: {missing_strategies}")
 else:
 print(" All 3 expert strategies generated successfully")
 ...
 "Wheel Strategy (SPY)", "GET", "expert-options/wheel/SPY", 200
 )
 ...
 print(
 f" - Capital Required: ${strategy.get('capital_required', 0):.2f}"
 )
 print(f" - ROI Potential: {strategy.get('roi_potential', 0):.2f}%")
 print(
 f" - Confidence Score: {strategy.get('confidence_score', 0):.3f}"
 )
 ...
 print(
 f" {i+1}. {leg.get('action', 'N/A')} {leg.get('option_type', 'N/A')} @ ${leg.get('strike', 0):.2f}"
 )
 print(
 f" Premium: ${leg.get('premium', 0):.2f}, Delta: {leg.get('delta', 0):.3f}"
 )

 # Test Iron Condor Strategy
 print("\n 🦅 Testing Iron Condor Strategy")
 success, condor_data = self.run_test(
 "Iron Condor Strategy (SPY)", "GET", "expert-options/iron-condor/SPY", 200
 )
 ...
 print(f" Symbol: {symbol}")
 print(" 🦅 Iron Condor Strategy Details:")
 print(f" - Strategy Type: {strategy.get('strategy_type', 'N/A')}")
 print(f" - Current Price: ${strategy.get('current_price', 0):.2f}")
 ...
 print(f" Symbol: {symbol}")
 print(" Volatility Play Strategy Details:")
 print(f" - Strategy Type: {strategy.get('strategy_type', 'N/A')}")
 ...
 print(f" - Breakeven Low: ${strategy.get('breakeven_low', 0):.2f}")
 print(
 f" - IV Expansion Needed: {strategy.get('iv_expansion_needed', 0):.1f}%"
 )
 print(
 f" - Confidence Score: {strategy.get('confidence_score', 0):.3f}"
 )
 ...
 "Market Analysis (SPY)", "GET", "expert-options/market-analysis/SPY", 200
 )
 ...
 print(
 f" - Historical Volatility (30d): {conditions.get('hv_30', 0):.1f}%"
 )
 ...
 print(
 f" - Optimal Strategy: {conditions.get('optimal_strategy', 'N/A')}"
 )
 ...
 missing_conditions = [
 field for field in required_conditions if field not in conditions
 ]

 if missing_conditions:
 print(f" Missing market conditions: {missing_conditions}")
 else:
 print(" Complete market analysis provided")

 # Test 4: Learning Insights
 print("\n🧠 TEST 4: Learning System Insights")
 print("-" * 60)
 success, insights_data = self.run_test(
 "Learning System Insights", "GET", "expert-options/learning/insights", 200
 )
 ...
 print(
 f" - Strategy Performance Data: {len(strategy_performance)} strategies"
 )
 ...
 print(f" * {strategy.replace('_', ' ').title()}:")
 print(
 f" - Status: {' Optimized' if optimized else '⏳ Learning'}"
 )
 ...
 print(
 f" - Preferred Strategy: {market_insights.get('preferred_strategy', 'N/A')}"
 )
 print(
 f" - Current Conditions: {market_insights.get('current_conditions', 'N/A')}"
 )
 print(
 f" - IV Environment: {market_insights.get('iv_environment', 'N/A')}"
 )
 ...
 if success:
 print(" 🔧 Wheel Strategy Optimization Result:")
 ...
 "wheel_strategy": wheel_data.get("strategy", {}).get("strategy_type")
 == "wheel",
 "iron_condor_strategy": condor_data.get("strategy", {}).get("strategy_type")
 == "iron_condor",
 "volatility_strategy": vol_data.get("strategy", {}).get("strategy_type")
 == "volatility_play",
 ...
 print(
 f" Validation Results: {passed_validations}/{total_validations} passed"
 )
 ...
 if success_rate >= 85:
 print(" EXCELLENT: Expert Options Trading System is fully operational!")
 print(
 " 🤖 AI-powered options strategies with confidence scores working perfectly"
 )
 print(
 " All 3 strategies (Wheel, Iron Condor, Volatility Play) generating properly"
 )
 print(
 " 🧠 Machine learning insights and parameter optimization functional"
 )
 print(" Market analysis providing comprehensive conditions assessment")
 print(" Parameter optimization system ready for continuous learning")
 elif success_rate >= 70:
 print(" GOOD: Expert Options system mostly working with minor issues")
 print(
 " 🔧 Some components may need attention but core functionality works"
 )
 else:
 print(" NEEDS ATTENTION: Expert Options system has significant issues")
 print(" 🚨 Multiple components failing - requires debugging")
...
def main():
 ...
 print(" EXPERT OPTIONS SYSTEM NEEDS ATTENTION!")
