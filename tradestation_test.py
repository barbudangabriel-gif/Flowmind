...
class TradeStationAPITester:
 ...
 print(" TradeStation not authenticated (expected for testing)")
 ...
 print(" No accounts found - using test account ID")
 ...
 print(" PARTIAL: TradeStation API integration has significant issues.")
 print(
