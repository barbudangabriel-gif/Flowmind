...
def cached_response(
    ...
    logger.info(" Executing function without cache")
    ...
    logger.warning(
        f" cached_response decorator used on sync function {func.__name__}. "
...
def invalidate_cache(
    ...
    logger.warning(
        f" Pattern-based cache invalidation not fully implemented. "
        f"Pattern: {pattern}"
    )
    return 0
