...
class PortfolioChartsService:
 ...
 portfolio_summary = await self._calculate_portfolio_summary(portfolio_id, performance_data)
 ...
 'cumulative_combined': round(base_stocks + base_options + stocks_trend + options_trend, 2)
 })
 ...
 {'name': 'GOOGL', 'value': 15000, 'type': 'stocks', 'count': 2, 'sector': 'Technology'},
 {'name': 'NVDA', 'value': 12000, 'type': 'stocks', 'count': 4, 'sector': 'Technology'},
 {'name': 'JPM', 'value': 18000, 'type': 'stocks', 'count': 3, 'sector': 'Finance'},
 {'name': 'JNJ', 'value': 14000, 'type': 'stocks', 'count': 2, 'sector': 'Healthcare'},
 ...
 filtered_positions = [pos for pos in all_positions if pos['type'] == 'stocks']
 elif asset_type == 'options':
 filtered_positions = [pos for pos in all_positions if pos['type'] == 'options']
 else: # combined
 ...
 portfolio_info = portfolio_values.get(portfolio_id, portfolio_values['htech-15t'])
 ...
 'pnl_percentage': round((total_pnl / portfolio_info['total_value']) * 100, 2) if portfolio_info['total_value'] > 0 else 0
 }