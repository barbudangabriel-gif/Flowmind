...
SP500_TICKERS = [
    ...
    "MU", "AMAT", "LRCX", "ADI", "KLAC", "MCHP", "CDNS", "SNPS", "FTNT", "PANW",
    
    # Healthcare & Biotech
    "UNH", "JNJ", "PFE", "ABBV", "MRK", "LLY", "TMO", "ABT", "DHR", "BMY",
    "AMGN", "GILD", "VRTX", "CVS", "CI", "HUM", "ANTM", "ZTS", "REGN", "BIIB",
    
    # Financial Services
    "BRK-B", "JPM", "BAC", "WFC", "GS", "MS", "C", "AXP", "USB", "PNC",
    "TFC", "COF", "SCHW", "CME", "ICE", "SPGI", "MCO", "BLK", "CB", "AIG",
    
    # Consumer & Retail
    "AMZN", "WMT", "HD", "PG", "KO", "PEP", "COST", "MCD", "NKE", "SBUX",
    "TGT", "LOW", "TJX", "DIS", "CMCSA", "VZ", "T", "NFLX", "CL", "KMB",
...
NASDAQ_TICKERS = [
    ...
    # Biotech & Healthcare
    "AMGN", "GILD", "VRTX", "BIIB", "REGN", "CELG", "ILMN", "ALXN", "BMRN", "INCY",
    
    # Consumer & Services  
    "COST", "SBUX", "MAR", "BKNG", "EBAY", "FAST", "PAYX", "FISV", "ADP", "ROST",
    
    # Other Important
    "CHTR", "ATVI", "EA", "WBA", "MDLZ", "DLTR", "VRSK", "CTSH", "VRSN", "XLNX"
]

# Popular crypto and forex tickers for additional coverage
ADDITIONAL_TICKERS = [
    "BTC-USD", "ETH-USD", "SPY", "QQQ", "IWM", "VTI", "VTV", "VUG", "IVV", "VOO"
]
...
class TickerDataManager:
    ...
    async def get_ticker_info_batch(self, tickers: List[str], max_batch_size: int = 20) -> List[Dict[str, Any]]:
    ...
    def _meets_criteria(self, stock: Dict[str, Any], criteria: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if 'min_market_cap' in criteria and criteria['min_market_cap'] and stock['market_cap']:
                if stock['market_cap'] < float(criteria['min_market_cap']) * 1000000:  # Convert to millions
                    return False
