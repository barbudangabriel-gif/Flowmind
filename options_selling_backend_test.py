...
class OptionsSellingSMonitorTester:
    ...
    def test_existing_compute_endpoint(self):
        ...
        try:
            ...
            self.log_result(
                "Options Selling Compute Endpoint", False, f"Error: {str(e)}", True
            )
            return False
    ...
    def test_monitor_start_endpoint(self):
        ...
        try:
            ...
            self.log_result("Monitor Start Endpoint", False, f"Error: {str(e)}", True)
            return False
    ...
    def test_monitor_status_endpoint(self):
        ...
        try:
            ...
            self.log_result("Monitor Status Endpoint", False, f"Error: {str(e)}", True)
            return False
    ...
    def test_monitor_stop_endpoint(self):
        ...
        try:
                ...
                if status_response.status_code == 200:
                    ...
                    if status_response_data.get("running") == False:
                        self.log_result(
                            ...
                            True,
                            "Confirmed running=false after stop",
                        )
                        return True
                    else:
                        self.log_result(
            ...
            self.log_result("Monitor Stop Endpoint", False, f"Error: {str(e)}", True)
            return False
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if (
                    ...
                    and data.get("data", {}).get("status") == "started"
                ):
                    self.log_result(
                        "Robustness - Start with mode=both",
                        True,
                        "Successfully started with mode=both",
                    )
                    ...
                    if status_response.status_code == 200:
                        ...
                        signals_current = status_response_data.get(
                            "signals_current", []
                        )
                    ...
                    self.log_result(
                        "Robustness - Start with mode=both",
                        False,
                        "Failed to start with mode=both",
                        True,
                    )
                    return False
            else:
            ...
            if stop_response.status_code == 200:
                ...
                if (
                    stop_data.get("status") == "success"
                    and stop_data.get("data", {}).get("status") == "stopped"
                ):
                    self.log_result(
                        "Robustness - Stop Again",
                        True,
                        "Successfully stopped monitor again",
                    )
                    return True
                else:
                    self.log_result(
            ...
            self.log_result("Robustness Scenarios", False, f"Error: {str(e)}", True)
            return False
        ...
        for endpoint in endpoints_to_test:
            if not endpoint.startswith("/api"):
                compliance_issues.append(
                    f"Endpoint {endpoint} does not start with /api"
                )
    ...
    def run_comprehensive_test(self):
        ...
        critical_tests_passed = sum(
            1 for _, success in test_results[:5] if success
        )  # First 5 are critical
        overall_success = (
            critical_tests_passed >= 4 and len(self.critical_failures) == 0
        )
