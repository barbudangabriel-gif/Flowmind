...
class PortfolioManagementTester:
 ...
 print(
 " 1. GET /api/portfolio-management/portfolios - Should return 4 default portfolios"
 )
 print(
 " 2. GET /api/portfolio-management/portfolios/tradestation-main/positions - Should return 6 mock positions"
 )
 print(
 " 3. GET /api/portfolio-management/available-portfolios/tradestation-main - Should return 3 other portfolios"
 )
 print(
 " 4. POST /api/portfolio-management/move-position - Test moving position to Long Term portfolio"
 )
 print(
 " 5. POST /api/portfolio-management/create-portfolio - Test creating new custom portfolio"
 )
 print(
 " 6. GET /api/portfolio-management/aggregate-view - Should show aggregated portfolio data"
 )
 print(
 " 7. GET /api/portfolio-management/move-history/tradestation-main - Should show move history"
 )
 ...
 "Get All Portfolios", "GET", "portfolio-management/portfolios", 200
 )
 if not success:
 ...
 portfolios = (
 portfolios_data.get("portfolios", [])
 ...
 if len(portfolios) == 4:
 print(" Correct number of portfolios: 4")
 ...
 missing_portfolios = [
 pid for pid in expected_portfolio_ids if pid not in found_portfolio_ids
 ]
 ...
 print(
 f" Portfolio {i+1}: {portfolio.get('name', 'N/A')} ({portfolio.get('id', 'N/A')})"
 )
 ...
 "GET",
 "portfolio-management/available-portfolios/tradestation-main",
 200,
 )
 if not success:
 ...
 available_data.get("available_portfolios", [])
 ...
 print(" Correct number of available portfolios: 3")
 available_count_correct = True
 else:
 print(
 f" Expected 3 available portfolios, found {len(available_portfolios)}"
 )
 ...
 print(
 f" Available Portfolio {i+1}: {portfolio.get('name', 'N/A')} ({portfolio.get('id', 'N/A')})"
 )
 ...
 "POST",
 "portfolio-management/move-position",
 200,
 data=move_data,
 )
 if success:
 ...
 200,
 data=create_portfolio_data,
 )
 if success:
 print(" Custom portfolio created successfully")
 ...
 print(" Custom portfolio creation failed")
 ...
 "Get Aggregate View", "GET", "portfolio-management/aggregate-view", 200
 )
 if success:
 ...
 "Get Move History",
 "GET",
 "portfolio-management/move-history/tradestation-main",
 200,
 )
 if success:
 ...
 test_phases = [
 (
 "Get All Portfolios (4 expected)",
 portfolios_count_correct and expected_portfolios_found,
 ),
 (
 ...
 print(
 f" - Portfolio Creation: {' Working' if create_portfolio_success else ' Failed'}"
 )
 print(
 ...
 " GET /api/portfolio-management/portfolios returns 4 default portfolios"
 )
 else:
 requirements_met.append(
 " GET /api/portfolio-management/portfolios - Portfolio count/structure issues"
 )

 if positions_count_correct and expected_symbols_found:
 requirements_met.append(
 " GET /api/portfolio-management/portfolios/tradestation-main/positions returns 6 mock positions"
 )
 else:
 requirements_met.append(
 " GET /api/portfolio-management/portfolios/tradestation-main/positions - Position issues"
 )

 if available_count_correct:
 requirements_met.append(
 " GET /api/portfolio-management/available-portfolios/tradestation-main returns 3 other portfolios"
 )
 else:
 requirements_met.append(
 " GET /api/portfolio-management/available-portfolios/tradestation-main - Count issues"
 )

 if move_position_success:
 requirements_met.append(
 " POST /api/portfolio-management/move-position - Position move functionality working"
 )
 else:
 requirements_met.append(
 " POST /api/portfolio-management/move-position - Move functionality failed"
 )

 if create_portfolio_success:
 requirements_met.append(
 " POST /api/portfolio-management/create-portfolio - Custom portfolio creation working"
 )
 else:
 requirements_met.append(
 " POST /api/portfolio-management/create-portfolio - Creation failed"
 )

 if aggregate_view_success:
 requirements_met.append(
 " GET /api/portfolio-management/aggregate-view - Aggregated portfolio data working"
 )
 else:
 requirements_met.append(
 " GET /api/portfolio-management/aggregate-view - Aggregate view failed"
 )

 if move_history_success:
 requirements_met.append(
 " GET /api/portfolio-management/move-history/tradestation-main - Move history working"
 )
 else:
 requirements_met.append(
 " GET /api/portfolio-management/move-history/tradestation-main - History failed"
 )
 ...
 print(
 " The 'Move to Portfolio X' functionality is ready for frontend integration."
 )
