#!/usr/bin/env python3
"""
Test script specifically for Mindfolio Charts and Smart Rebalancing Agent endpoints
"""
...
def main():
 print(" Testing Mindfolio Charts and Smart Rebalancing Agent Endpoints")
 print("=" * 80)
 
 # Initialize tester
 tester = StockMarketAPITester()
 
 # Test Mindfolio Charts endpoints
 print("\n TESTING MINDFOLIO CHARTS ENDPOINTS")
 print("=" * 60)
 mindfolio_charts_success = tester.test_mindfolio_charts_endpoints()
 ...
 results = [
 ("Mindfolio Charts Endpoints", mindfolio_charts_success),
 ...
 if success_rate >= 85:
 print("\n EXCELLENT: Mindfolio Charts and Smart Rebalancing Agent endpoints working perfectly!")
