...
class UnusualWhalesAPITester:
    ...
    def test_options_flow_api(self):
            ...
            if success_filter:
                ...
                if filtered_alerts:
                    ...
                    if min_premium_actual >= min_premium:
                        ...
                        print(
                            f"     ⚠️  Filter issue: found ${min_premium_actual:,} < ${min_premium:,}"
                        )
        ...
        print(
            f"   - Data Quality: {'✅ REAL DATA' if is_real_data else '⚠️  MOCK/NO DATA'}"
        )
        print(f"   - Response Time: {response_time:.2f}s")
        print(
    ...
    def test_dark_pool_api(self):
        ...
        print(
            f"   - Data Quality: {'✅ REAL DATA' if len(trades) > 0 else '⚠️  NO DATA (may be normal)'}"
        )
        print(f"   - Response Time: {response_time:.2f}s")
        print(f"   - API Status: {status}")
    ...
    def test_congressional_trades_api(self):
        ...
        print(f"   - Trades Found: {len(trades)}")
        print(
            f"   - Data Quality: {'✅ REAL DATA' if len(trades) > 0 else '⚠️  NO DATA'}"
        )
        print(f"   - Response Time: {response_time:.2f}s")
        print(f"   - API Status: {status}")
    ...
    def test_trading_strategies_api(self):
        ...
        if strategies:
            ...
            print(
                "⚠️  No strategies found - this may be normal if no qualifying signals exist"
            )
