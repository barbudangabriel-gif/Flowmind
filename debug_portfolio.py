#!/usr/bin/env python3
"""
Debug script to test portfolio service data processing
"""
...
def test_portfolio_processing():
    """Test the portfolio processing logic"""
    print("\nTesting portfolio processing logic...")
...
if __name__ == "__main__":
    print("🔍 Debug Portfolio Service Data Processing")
    print("=" * 50)
    
    # Test individual position creation
    test_position = test_position_creation()
    
    # Test full portfolio processing
    positions, metrics = test_portfolio_processing()
