...
class ChartIntegrationTester:
    ...
    def test_enhanced_trading_strategies_with_charts(self):
        ...
        if not strategies:
            print(
                "⚠️  No strategies generated - this may be expected if no unusual activity"
            )
            return True
        ...
        for i, strategy in enumerate(strategies):
            ...
            if expected_type:
                if chart_type == expected_type:
                    ...
                    print(
                        f"   ⚠️  Chart Type Mapping: Expected {expected_type}, got {chart_type}"
                    )
            else:
                print(
                    f"   ℹ️  Chart Type Mapping: Unknown strategy pattern, got {chart_type}"
                )
            ...
            try:
                ...
                if chart_data_traces and len(chart_data_traces) > 0:
                    ...
                    if x_data and y_data and len(x_data) > 0 and len(y_data) > 0:
                        ...
                        if isinstance(x_data[0], (int, float)) and isinstance(
                            ...
                            print("   ⚠️  Data Types: Non-numeric data detected")
                    else:
                ...
                if "title" in layout and "xaxis" in layout and "yaxis" in layout:
                    ...
                    print("   ⚠️  Chart Layout: Incomplete layout structure")
            ...
            if metrics_found:
                ...
                print("   ⚠️  Chart Metrics: No financial metrics found")
