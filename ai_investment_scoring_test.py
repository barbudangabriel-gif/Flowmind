    ...
    def test_ai_investment_scoring_agent_comprehensive(self):
        ...
        if len(successful_symbols) >= 2:
            ...
            if len(set(scores)) > 1:
                ...
                print("   ⚠️  All scores identical - may indicate static responses")
        ...
        if success_empty:
            ...
            print("     ⚠️  Empty symbol handling unclear")
        ...
        if success_rate >= 85:
            ...
            print("   ⚠️  Minor issues may exist but core functionality works")
        else:
            print("   ❌ ISSUES: AI Investment Scoring Agent has problems")
            print("   🚨 May explain user's 'agent not working' problem")
