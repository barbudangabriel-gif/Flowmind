            ...
            if response.status_code == 200:
                ...
                if len(positions) > 0:
                    ...
                    if value_difference_percent < 5:
                        ...
                        print(
                            f"   ⚠️ Portfolio value differs significantly ({value_difference_percent:.1f}%)"
                        )
                else:
    ...
    def generate_final_report(self, results):
        ...
        if results["actual_portfolio_value"] > 0:
            ...
            if results["portfolio_value_correct"]:
                ...
                print(
                    f"   ⚠️ Portfolio value differs from expected ${self.expected_portfolio_value:,.2f}"
                )
        ...
        if success_rate >= 80:
            ...
            if not results["portfolio_value_correct"]:
                print("   ⚠️ Portfolio value differs from expected, but API is working")
            print(
