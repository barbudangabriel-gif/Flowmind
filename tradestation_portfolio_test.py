...
class TradeStationPortfolioTester:
 ...
 print(
 " 1. Test /api/tradestation/accounts/11775499/summary for portfolio positions"
 )
 print(
 ...
 print(
 " WARNING: Not authenticated - portfolio data may be limited or mock"
 )
 print(
 ...
 if not success:
 print(
 " Portfolio Summary endpoint failed - cannot test dropdown functionality"
 )
 return False
 ...
 print(
 " Frontend expects: {portfolio_metrics, positions, risk_analysis}"
 )
 print(
 " Backend returns: {status, data: {portfolio_metrics, positions, risk_analysis}}"
 )
 print(
 ...
 print(
 f" Portfolio Metrics: {' Present' if portfolio_metrics else ' Missing'}"
 )
 print(
 ...
 "Portfolio Summary (Performance Test)",
 "GET",
 f"tradestation/accounts/{self.account_id}/summary",
 200,
 )
 ...
 print(" - Change: response.portfolio_metrics")
 print(" - To: response.data.portfolio_metrics")
