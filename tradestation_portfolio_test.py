...
class TradeStationPortfolioTester:
    ...
    def test_tradestation_portfolio_dropdown_functionality(self):
        ...
        if not authenticated:
            print(
                "⚠️  WARNING: Not authenticated - portfolio data may be limited or mock"
            )
            print(
        ...
        for symbol in user_symbols:
            ...
            if symbol_positions:
                ...
                if len(stock_pos) > 0 and len(option_pos) > 0:
                    ...
                    print("     ⚠️  DROPDOWN NOT NEEDED: Only single position type")
        ...
        if response_time < 1.0:
            ...
            print("   ⚠️  Slow response time - may affect user experience")
        ...
        if len(dropdown_candidates) > 0:
            ...
            print("   ⚠️  NO DROPDOWN CANDIDATES: No symbols have multiple positions")

        if not authenticated:
            print("   ⚠️  AUTHENTICATION ISSUE: May be showing mock/limited data")
