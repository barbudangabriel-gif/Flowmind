...
class EnhancedPortfolioTester:
 ...
 "Get Portfolio (Empty)", "GET", "portfolio", 200
 )
 if success:
 ...
 if missing_fields:
 print(f" Missing portfolio summary fields: {missing_fields}")
 else:
 print(" All required portfolio summary fields present")
 ...
 "Add AAPL Position", "POST", "portfolio", 200, data=aapl_position
 )
 aapl_id = None
 ...
 "Add MSFT Position", "POST", "portfolio", 200, data=msft_position
 )
 msft_id = None
 ...
 success, full_portfolio = self.run_test(
 "Get Portfolio (With Positions)", "GET", "portfolio", 200
 )
 if success:
 ...
 print(
 f" Total P&L: ${full_portfolio.get('total_profit_loss', 0):.2f} ({full_portfolio.get('total_profit_loss_percent', 0):.2f}%)"
 )
