...
def test_chart_data_details():
    ...
    url = "https://flowmind-analytics-2.preview.emergentagent.com/api/unusual-whales/trading-strategies"
    ...
    try:
        ...
        print(f"🎯 DETAILED CHART DATA ANALYSIS")
        ...
        for i, strategy in enumerate(strategies):
            ...
            if 'chart' in strategy:
                ...
                if 'plotly_chart' in chart:
                    ...
                    print(f"   ❌ No plotly_chart field")
            else:
                print(f"   ❌ No chart field")
