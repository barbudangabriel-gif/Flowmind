...
const TradingChartTest = ({ symbol = 'META', interval = '1D', height = 500 }) => {
 ...
 <div className="text-green-400 font-medium text-3xl">🧪 Testing Lightweight Charts v5.0.8</div>
 <div className="text-gray-400 text-xl mt-2">Mock data test for {symbol}</div>
 <div className="text-gray-500 text-lg mt-1">Static import • Mock data • Dual charts</div>
 </div>
 </div>
 </div>
 );
 ...
 <div className="text-red-400 text-2xl font-medium mb-3">💥 Test Chart Error</div>
 ...
 <div className="text-center">
 <span className="text-[rgb(252, 251, 255)] text-3xl font-medium">🧪 LIGHTWEIGHT CHARTS v5.0.8 TEST - SUCCESS!</span>
 <div className="text-green-200 text-xl mt-1">
 ...
 <span className="text-[rgb(252, 251, 255)] font-medium">Chart Integration: WORKING</span>
 ...
 <span className="text-green-200 font-medium">Lightweight Charts v5.0.8</span>
 <span className="text-gray-300 mx-1">•</span>
