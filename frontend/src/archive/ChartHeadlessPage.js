...
export default function ChartHeadlessPage() {
 ...
 <h1 className="text-2xl font-medium text-gray-900 dark:text-[rgb(252, 251, 255)] flex items-center gap-3">
 <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center text-[rgb(252, 251, 255)]">
 ...
 <h3 className="text-3xl font-medium text-gray-900 dark:text-[rgb(252, 251, 255)] mb-3">✨ Features</h3>
 ...
 {/* Integration */}
 <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
 <h3 className="text-3xl font-medium text-gray-900 dark:text-[rgb(252, 251, 255)] mb-3"> Integration</h3>
 <div className="space-y-3 text-xl text-gray-600 dark:text-gray-400">
 <div>
 <strong>Route:</strong>
 ...
 <code className="ml-2 px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-lg">
 ...
 <h3 className="text-3xl font-medium text-blue-900 dark:text-blue-300 mb-2"> Implementation Status</h3>
 ...
 <h3 className="text-3xl font-medium text-gray-900 dark:text-[rgb(252, 251, 255)] mb-3"> Usage Examples</h3>
