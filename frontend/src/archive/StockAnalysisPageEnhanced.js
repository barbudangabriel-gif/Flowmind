...
const StockAnalysisPageEnhanced = () => {
 ...
 <h2 className="text-2xl font-medium text-[rgb(252, 251, 255)] mb-2">Se încarcă analiza</h2>
 ...
 <h2 className="text-2xl font-medium text-[rgb(252, 251, 255)] mb-2">Eroare Analiză</h2>
 <p className="text-gray-400 mb-4">{error}</p>
 <div className="space-x-4">
 <button
 onClick={() => navigate(-1)}
 className="bg-gray-600 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors"
 >
 Înapoi
 </button>
 <button
 onClick={loadAnalysis}
 className="bg-blue-600 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
 >
 Reîncearcă
 </button>
 </div>
 ...
 <button
 onClick={() => navigate(-1)}
 className="flex items-center space-x-2 text-gray-300 hover:text-[rgb(252, 251, 255)] transition-colors"
 >
 <ArrowLeft size={20} />
 <span>Scoring</span>
 </button>
 ...
 <div className="text-2xl font-medium text-[rgb(252, 251, 255)]">
 ...
 <button
 onClick={loadAnalysis}
 className="bg-blue-600 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-2"
 >
 <RefreshCw size={16} />
 ...
 <div className="text-right">
 <div className="text-3xl font-medium text-yellow-300">
 {analysis?.investmentScore?.toFixed(1) || '58.7'}
 </div>
 <div className="text-xl text-yellow-400">Investment Score</div>
 </div>
 </div>
 ...
 <div className="text-xl text-blue-400">Technical Score</div>
 </div>
 </div>
 ...
 <h3 className="text-xl font-medium text-[rgb(252, 251, 255)] mb-6 flex items-center">
 ...
 <span className="text-blue-400 font-medium">{analysis?.componentScores?.technical?.toFixed(1) || '62.5'}</span>
 </div>
 ...
 <span className="text-green-400 font-medium">{analysis?.componentScores?.fundamental?.toFixed(1) || '71.2'}</span>
 </div>
 <div className="w-full bg-gray-700 rounded-full h-2">
 <div 
 ...
 <span className="text-purple-400 font-medium">{analysis?.componentScores?.optionsFlow?.toFixed(1) || '45.8'}</span>
 </div>
 <div className="w-full bg-gray-700 rounded-full h-2">
 <div 
 ...
 <span className="text-orange-400 font-medium">{analysis?.componentScores?.sentiment?.toFixed(1) || '58.3'}</span>
 </div>
 <div className="w-full bg-gray-700 rounded-full h-2">
 <div 
 ...
 <span className="text-red-400 font-medium">{analysis?.componentScores?.risk?.toFixed(1) || '76.1'}</span>
 </div>
 <div className="w-full bg-gray-700 rounded-full h-2">
 <div 
 ...
 <span className="text-green-400 text-xl font-medium">BULLISH</span>
 </div>
 ...
 <span className="text-blue-400 text-xl font-medium">NEUTRAL</span>
 </div>
 ...
 <span className="text-yellow-400 text-xl font-medium">WATCH</span>
 </div>
 </div>
 </div>
 </div>
 ...
 {/* Key Strengths */}
 <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
 <h3 className="text-xl font-medium text-[rgb(252, 251, 255)] mb-4 flex items-center">
 ...
 <span className="text-green-300 text-xl">{strength}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <span className="text-red-300 text-xl">{risk}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <span className="text-blue-300 text-xl">TradeStation API</span>
 <div className="w-2 h-2 bg-green-400 rounded-full"></div>
 </div>
 <div className="flex items-center justify-between p-2 bg-purple-900 rounded-lg">
 <span className="text-purple-300 text-xl">Unusual Whales</span>
 <div className="w-2 h-2 bg-green-400 rounded-full"></div>
 </div>
 <div className="flex items-center justify-between p-2 bg-indigo-900 rounded-lg">
 <span className="text-indigo-300 text-xl">Smart Money Concepts</span>
 <div className="w-2 h-2 bg-green-400 rounded-full"></div>
 </div>
 </div>
 ...
 <div className="text-3xl font-medium">Investment Recommendation</div>
 <div className="text-gray-400 text-xl">Based on comprehensive analysis</div>
 </div>
 </div>
 
 <div className="flex items-center space-x-4">
 <div className={`px-6 py-3 rounded-lg font-medium text-3xl border ${getVerdictColor(analysis?.recommendation || 'HOLD')}`}>
 {analysis?.recommendation || 'HOLD'}
 </div>
 <button className="bg-blue-600 hover:bg-blue-700 text-[rgb(252, 251, 255)] px-6 py-3 rounded-lg font-medium transition-colors">
 Add to Watchlist
 </button>
 </div>
 </div>
