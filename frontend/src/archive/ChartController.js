              ...
              return (
                <>
                  ...
                  <div>
                    ...
                    <div className={`font-mono font-semibold ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                      {change >= 0 ? '+' : ''}{change.toFixed(2)} ({changePercent.toFixed(2)}%)
                    </div>
                  </div>
                  <div>
                    <span className="text-gray-500">High:</span>
                    <div className="font-mono font-semibold">${latest.high.toFixed(2)}</div>
                  </div>
                  <div>
                    <span className="text-gray-500">Low:</span>
                    <div className="font-mono font-semibold">${latest.low.toFixed(2)}</div>
                  </div>
                </>
              );
            })()}
