...
export default function ChartProPlusPlusPlus() {
 ...
 <div className="flex items-center justify-center gap-2 mt-3 text-xl text-brand-600">
 ...
 <Label className="font-medium">Technical Indicators:</Label>
 ...
 {rangesInfo.length > 0 && (
 <div className="text-lg grid gap-1 bg-card p-3 rounded-lg border border-border">
