...
export default function ChartProTSLive({ 
 ...
 <h1 className="text-3xl font-medium flex items-center justify-center gap-3">
 <div className="w-12 h-12 bg-gradient-to-r from-brand-500 to-brand-600 rounded-xl flex items-center justify-center text-[rgb(252, 251, 255)]">
 ...
 {TF_OPTS.map(t => (
 <TabsTrigger key={t.v} value={t.v} className="text-lg">
 {t.label}
 </TabsTrigger>
 ))}
 </TabsList>
 ...
 <div className="ml-auto text-lg text-muted-foreground flex items-center gap-2">
 <span>Status:</span>
 ...
 <div className="flex flex-wrap items-center gap-4 text-xl bg-card p-4 rounded-lg border border-border">
 <Label className="font-medium text-foreground">Technical Indicators:</Label>
 ...
 <Label className="font-medium">📡 Live Market Data</Label>
 ...
 <div className="font-mono font-medium">${latest.open.toFixed(2)}</div>
 </div>
 <div>
 <div className="text-muted-foreground">High</div>
 <div className="font-mono font-medium text-green-600">${latest.high.toFixed(2)}</div>
 </div>
 <div>
 <div className="text-muted-foreground">Low</div>
 <div className="font-mono font-medium text-red-600">${latest.low.toFixed(2)}</div>
 </div>
 <div>
 ...
 <div className="font-mono font-medium text-blue-600">{latest.volume.toLocaleString()}</div>
 </div>
 </>
 );
 })()}
 ...
 className="min-h-[260px] font-mono text-lg" 
 placeholder={`{\n "hlines": [...],\n "trends": [...],\n ...\n}`} 
 />
 ...
 {/* Status Footer */}
 <div className="text-center text-lg text-muted-foreground bg-card p-3 rounded-lg border border-border">
