    ...
    <div className="p-4 space-y-3">
      ...
      <div className="flex items-center justify-between p-3 bg-gray-800 rounded-lg border border-gray-700">
        ...
        <div className={`flex items-center gap-2 text-sm font-medium ${getStatusColor()}`}>
          ...
          {isLive && <span className="text-xs text-green-400 ml-2">LIVE DATA</span>}
        </div>
      </div>
      ...
      {bars.length > 0 && (
        <div className="bg-gray-800 p-4 rounded border border-gray-700">
          <h4 className="text-white font-semibold mb-2">Latest Bar</h4>
              ...
              return (
                <>
                  ...
                  <div>
                    ...
                    <div className="text-white font-mono">${latest.close.toFixed(2)}</div>
                  </div>
                  <div>
