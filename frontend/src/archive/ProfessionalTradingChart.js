...
const ProfessionalTradingChart = ({ symbol, height = 500 }) => {
 ...
 <div class="text-[rgb(252, 251, 255)] font-medium mb-2">${date}</div>
 <div class="space-y-1 text-xl">
 <div class="flex justify-between gap-4">
 <span class="text-gray-300">Open:</span>
 <span class="text-[rgb(252, 251, 255)] font-mono">$${o?.toFixed(2) || 'N/A'}</span>
 </div>
 <div class="flex justify-between gap-4">
 ...
 console.warn(` TradeStation historical data failed:`, histError.message);
 }
 ...
 <div className="text-purple-400 font-medium text-xl"> Loading TradeStation Data</div>
 <div className="text-gray-400 text-xl mt-2">TradeStation API • Real-time quotes • {symbol}</div>
 <div className="text-gray-500 text-lg mt-1">Professional Trading Platform</div>
 </div>
 </div>
 </div>
 );
 ...
 <div className="text-red-400 text-2xl font-medium mb-3">💥 Professional Chart Error</div>
 ...
 <div>
 <h3 className="text-3xl font-medium text-[rgb(252, 251, 255)] flex items-center">
 {symbol} <span className="ml-2 text-purple-300">Professional</span>
 </h3>
 <div className="flex items-center space-x-3 mt-1">
 <div className="text-[rgb(252, 251, 255)]">
 <span className="text-gray-300 text-xl">Price: </span>
 <span className="text-3xl font-medium">${currentPrice.toFixed(2)}</span>
 </div>
 <div className={`flex items-center text-xl ${priceChange >= 0 ? 'text-green-400' : 'text-red-400'}`}>
 ...
 <div className="text-purple-300 font-medium text-xl">
 TradeStation
 </div>
 </div>
 </div>
 ...
 <span className="text-purple-400 font-medium">TradeStation</span>
 </div>
 </div>
 </div>
 </div>
