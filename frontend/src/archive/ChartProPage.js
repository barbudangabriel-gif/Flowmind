...
export default function ChartProPage() {
 ...
 <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg flex items-center justify-center text-[rgb(252, 251, 255)]">
 ...
 <h3 className="text-3xl font-medium mb-3 flex items-center gap-2">
 ✏️ Enhanced Drawing Tools
 </h3>
 <ul className="space-y-1 text-xl text-gray-600 dark:text-gray-400">
 ...
 <h3 className="text-xl font-medium text-purple-900 dark:text-purple-300 mb-4"> Chart Pro+++ Ultimate Features</h3>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
 <div>
 <h4 className="font-medium text-purple-800 dark:text-purple-200 mb-2"> Advanced Drawing</h4>
 <ul className="space-y-1 text-xl text-purple-700 dark:text-purple-300">
 ...
 <div>
 <h4 className="font-medium text-purple-800 dark:text-purple-200 mb-2">💾 Data Management</h4>
 <ul className="space-y-1 text-xl text-purple-700 dark:text-purple-300">
 ...
 <div>
 <h4 className="font-medium text-purple-800 dark:text-purple-200 mb-2"> Professional Tools</h4>
 <ul className="space-y-1 text-xl text-purple-700 dark:text-purple-300">
