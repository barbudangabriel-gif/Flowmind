...
export default function ChartPage() {
 ...
 return (
 <div className="min-h-screen bg-gray-900 text-[rgb(252, 251, 255)]">
 {/* Header */}
 ...
 <h3 className="text-3xl font-medium mb-2 text-blue-300"> Usage Examples:</h3>
 ...
 <h3 className="text-3xl font-medium mb-2 text-green-300"> Chart Implementation Status:</h3>
 <div className="space-y-2 text-xl text-green-200">
