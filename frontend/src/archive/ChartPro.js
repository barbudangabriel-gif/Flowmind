...
export default function ChartProPlus({
  ...
  return (
    <div className="p-4 space-y-3">
      ...
      {/* Indicators Panel */}
      <div className="flex flex-wrap items-center gap-2 text-sm bg-neutral-50 dark:bg-neutral-800 p-2 rounded border border-neutral-200 dark:border-neutral-700">
      ...
      {(items.hlines.length > 0 || items.vlines.length > 0 || items.trends.length > 0 || items.ranges.length > 0) && (
        <div className="bg-neutral-50 dark:bg-neutral-800 p-3 rounded border border-neutral-200 dark:border-neutral-700">
          <h4 className="font-medium mb-2 text-sm">Drawing Management</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
            ...
            <div className="p-2 rounded border border-neutral-300 dark:border-neutral-700">
              ...
              {items.hlines.map((it, idx) => (
                <div key={idx} className="flex items-center gap-2 mb-1">
                  ...
                  <input 
                    className="px-1 py-0.5 rounded border border-neutral-300 dark:border-neutral-700 flex-1 text-xs" 
                    placeholder="label" 
                    value={it.label || ''} 
            ...
            <div className="p-2 rounded border border-neutral-300 dark:border-neutral-700">
              ...
              {items.vlines.map((it, idx) => (
                <div key={idx} className="flex items-center gap-2 mb-1">
                  <span className="w-20 text-xs">{new Date(it.time * 1000).toLocaleDateString()}</span>
                  <input 
                    className="px-1 py-0.5 rounded border border-neutral-300 dark:border-neutral-700 flex-1 text-xs" 
                    placeholder="label" 
                    value={it.label || ''} 
            ...
            <div className="p-2 rounded border border-neutral-300 dark:border-neutral-700">
              ...
              {items.trends.map((it, idx) => (
                <div key={idx} className="flex items-center gap-2 mb-1">
                  <span className="w-24 text-xs font-mono">${it.aPrice.toFixed(2)}-${it.bPrice.toFixed(2)}</span>
                  <input 
                    className="px-1 py-0.5 rounded border border-neutral-300 dark:border-neutral-700 flex-1 text-xs" 
                    placeholder="label" 
                    value={it.label || ''} 
            ...
            <div className="p-2 rounded border border-neutral-300 dark:border-neutral-700">
              ...
              {items.ranges.map((it, idx) => (
                <div key={idx} className="flex items-center gap-2 mb-1">
                  <span className="w-20 text-xs">{new Date(it.aTime * 1000).toLocaleDateString()} → {new Date(it.bTime * 1000).toLocaleDateString()}</span>
                  <input 
                    className="px-1 py-0.5 rounded border border-neutral-300 dark:border-neutral-700 flex-1 text-xs" 
                    placeholder="label" 
                    value={it.label || ''} 
      ...
      {/* Range Stats */}
      {rangesInfo.length > 0 && (
        <div className="text-xs p-2 rounded border border-neutral-300 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800">
