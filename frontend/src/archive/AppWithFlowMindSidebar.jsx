  ...
  return (
    <Routes>
      ...
      <Route path="/stocks/scoring" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Investment Scoring</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/stocks/scanner" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Scoring Scanner</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/screener/sell-puts" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Sell Puts (Auto)</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/trades/preview" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Preview Queue</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/trades/orders/sim" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Orders (SIM)</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/trades/orders/live" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Orders (Live)</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/analytics/verified" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Verified Chains</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/providers/ts" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">TradeStation</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/md/quotes" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Market Quotes</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/md/chain" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Option Chain</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/providers/uw" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Unusual Whales</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/ops/redis" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Redis Diagnostics</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/ops/bt" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Backtest Ops</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/ops/emergent" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Emergent Status</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/ops/warmup" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Cache Warm-up</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/settings/gates" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Risk & Gates</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <Route path="/options/selling" element={
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Legacy: Options Selling</h2>
          <div className="bg-white rounded-lg p-6 shadow-sm">
