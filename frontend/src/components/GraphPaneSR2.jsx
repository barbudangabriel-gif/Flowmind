    ...
    <div className="relative h-[360px]" ref={chartRef}>
      ...
      {hover && (
        <>
          ...
          >
            <div className="px-2 py-1 rounded-lg bg-white text-slate-900 text-xs shadow-lg border border-slate-200">
              ${hover.x.toFixed(2)}
            </div>
          </div>
          ...
          >
            <div className="px-2 py-0.5 rounded bg-emerald-600 text-white text-xs shadow-lg">
              {yFmt(hover.v)}
            </div>
          </div>
