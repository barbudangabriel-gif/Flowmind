      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl relative">
          ...
          <div className="flex items-center justify-between p-8 pb-4">
            <h1 className="text-2xl font-bold text-gray-800">Add Symbols to Follow</h1>
            <button
          ...
          <div className="px-8 pb-8">
            ...
            <div className="mb-6">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 text-lg border-2 border-gray-300 rounded-xl focus:border-blue-500 focus:outline-none pr-12"
                />
            ...
            {selectedSymbols.length > 0 && (
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Selected Symbols ({selectedSymbols.length})</h3>
            ...
            <div className="flex space-x-4">
              ...
              <button
                onClick={handleNext}
                className="flex-1 py-4 px-6 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition-colors font-semibold"
              >
                Next
              </button>
            </div>
        ...
        <div className="px-8 pb-8 flex-1 flex flex-col">
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            {searchResults.length > 0 && (
              <>
                <h3 className="text-lg font-semibold text-gray-700 mb-4 flex-shrink-0">Results:</h3>
                ...
                <div className="flex-1 overflow-y-auto border border-gray-200 rounded-xl">
                  {searchResults.map((result, index) => (
                    ...
                    >
                      <div>
                        <div className="font-bold text-gray-800 text-lg">{result.symbol}</div>
          ...
          <div className="flex-shrink-0 mt-6">
            <div className="flex space-x-4">
              ...
              <button
                ...
                className="flex-1 py-3 px-6 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
