...
const InvestmentScoring = React.memo(() => {
 ...
 <div>
 <h3 className="text-3xl font-medium text-gray-800">{investment.symbol || 'N/A'}</h3>
 <span className={`inline-block px-2 py-1 rounded text-lg font-medium ${getRatingColor(investment.rating || 'HOLD')}`}>
 {investment.rating || 'HOLD'}
 </span>
 </div>
 <div className="text-right">
 <div className={`text-2xl font-medium ${getScoreColor(investment.total_score || 50)}`}>
 {investment.total_score || 'N/A'}
 </div>
 <div className="text-lg text-gray-500">Score</div>
 </div>
 </div>
 ...
 <span className={`text-lg px-2 py-1 rounded ${getRiskColor(investment.risk_level || 'MODERATE')}`}>
 {investment.risk_level || 'MODERATE'} RISK
 </span>
 </div>
 <div className="flex items-center space-x-1">
 <Timer className="w-4 h-4 text-gray-500" />
 <span className="text-lg text-gray-600">{investment.investment_horizon || 'MEDIUM-TERM'}</span>
 </div>
 </div>

 <p className="text-xl text-gray-600 mb-3">{investment.explanation || 'Investment analysis pending...'}</p>

 {showDetails && (
 <div className="space-y-3">
 <div>
 <h4 className="text-xl font-medium text-green-600 mb-1 flex items-center">
 <CheckCircle className="w-4 h-4 mr-1" />
 Key Strengths
 </h4>
 <div className="flex flex-wrap gap-1">
 {(investment.key_strengths || []).map((strength, idx) => (
 <span key={idx} className="text-lg bg-green-100 text-green-700 px-2 py-1 rounded">
 {strength}
 </span>
 ))}
 </div>
 ...
 <div>
 <h4 className="text-xl font-medium text-red-600 mb-1 flex items-center">
 <XCircle className="w-4 h-4 mr-1" />
 Key Risks
 </h4>
 <div className="flex flex-wrap gap-1">
 {(investment.key_risks || []).map((risk, idx) => (
 <span key={idx} className="text-lg bg-red-100 text-red-700 px-2 py-1 rounded">
 {risk}
 </span>
 ))}
 </div>
 ...
 <div>
 <div className="text-lg text-gray-500">Valuation Score</div>
 <div className="font-medium">{investment.individual_scores?.pe || 'N/A'}</div>
 </div>
 <div>
 <div className="text-lg text-gray-500">Momentum Score</div>
 ...
 <div>
 <h2 className="text-2xl font-medium text-gray-800"> Investment Scoring</h2>
 <p className="text-gray-600">AI-powered investment analysis and recommendations</p>
 </div>
 <div className="flex space-x-3">
 <button
 onClick={loadTopPicks}
 className="bg-blue-600 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center space-x-2"
 >
 <RefreshCw size={20} />
 <span>Refresh</span>
 </button>
 ...
 <h3 className="text-xl font-medium text-purple-800 mb-3 flex items-center">
 ...
 <h4 className="text-xl font-medium text-purple-800 mb-2 flex items-center">
 <AlertTriangle className="mr-2 text-orange-500" size={14} />
 Premium Penalty & Discount Scoring System
 </h4>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-lg">
 <div className="bg-red-50 p-3 rounded border-l-4 border-red-400">
 <div className="font-medium text-red-700 mb-1"> Premium Penalty</div>
 ...
 <div className="font-medium text-green-700 mb-1"> Discount Opportunity</div>
 ...
 <div className="text-lg text-purple-600 mt-2 italic">
 ...
 className="bg-gradient-to-r from-purple-600 to-blue-600 text-[rgb(252, 251, 255)] px-8 py-3 rounded-lg hover:from-purple-700 hover:to-blue-700 flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
 >
 {aiLoading ? (
 ...
 <div className="flex justify-between items-center">
 <h4 className="text-3xl font-medium text-gray-800 flex items-center">
 ...
 <p className="text-red-600 text-xl mt-2">{aiAnalysis.error}</p>
 </div>
 </div>
 ) : (
 ...
 <div className={`text-3xl font-medium ${getScoreColor(aiAnalysis.investment_score || 0)}`}>
 {aiAnalysis.investment_score || 0}
 </div>
 <div className="text-xl text-gray-500">Investment Score</div>
 <div className="mt-2">
 ...
 {/* Recommendation */}
 <div className="text-center">
 <div className={`inline-flex items-center px-4 py-2 rounded-full text-xl font-medium ${
 ...
 <div className="text-xl text-gray-500 mt-2">AI Recommendation</div>
 </div>
 ...
 <div className="text-xl text-gray-500 mt-2">Analysis Confidence</div>
 </div>
 </div>
 ...
 <div>
 <h5 className="text-3xl font-medium mb-3 flex items-center">
 ...
 <span className="text-xl font-medium text-gray-700">Overall Risk Level</span>
 <span className={`px-3 py-1 rounded-full text-xl font-medium ${getRiskColor(aiAnalysis.risk_analysis.overall_risk?.toUpperCase())}`}>
 ...
 <div>
 <div className="text-xl font-medium text-gray-700 mb-2">Risk Factors:</div>
 ...
 <div className="text-xl font-medium text-gray-700 capitalize mb-1">
 {signalType.replace('_', ' ')}
 </div>
 <div className="flex items-center justify-between">
 <span className={`text-3xl font-medium ${getScoreColor(score)}`}>
 ...
 <h6 className="text-xl font-medium text-blue-800 mb-2 flex items-center">
 <Activity className="mr-1" size={14} />
 Data Sources Used
 </h6>
 <div className="flex flex-wrap gap-2">
 {aiAnalysis.data_sources.map((source, index) => (
 <span key={index} className="bg-blue-100 text-blue-700 px-2 py-1 rounded-full text-lg">
 ...
 <h3 className="text-3xl font-medium text-blue-800 mb-2 flex items-center">
 ...
 <button
 onClick={loadTopPicks}
 className="mt-4 bg-blue-600 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg hover:bg-blue-700"
 >
 Refresh Data
 </button>
 </div>
 ...
 <tr>
 <th className="px-4 py-3 text-left text-lg font-medium text-gray-300 uppercase tracking-wider">Rank</th>
 <th className="px-4 py-3 text-left text-lg font-medium text-gray-300 uppercase tracking-wider">Symbol</th>
 <th className="px-4 py-3 text-left text-lg font-medium text-gray-300 uppercase tracking-wider">Price</th>
 <th className="px-4 py-3 text-left text-lg font-medium text-gray-300 uppercase tracking-wider">Score</th>
 <th className="px-4 py-3 text-left text-lg font-medium text-gray-300 uppercase tracking-wider">Rating</th>
 <th className="px-4 py-3 text-left text-lg font-medium text-gray-300 uppercase tracking-wider">Risk</th>
 <th className="px-4 py-3 text-left text-lg font-medium text-gray-300 uppercase tracking-wider">Description</th>
 </tr>
 </thead>
 ...
 <div className={`w-8 h-8 rounded-full flex items-center justify-center font-medium text-xl ${
 ...
 <td className="px-4 py-4">
 <div className="font-medium text-3xl text-blue-300 hover:text-blue-200 transition-colors">
 {pick?.symbol || 'N/A'}
 </div>
 </td>
 <td className="px-4 py-4">
 ...
 <td className="px-4 py-4">
 <div className={`text-2xl font-medium ${getScoreColor(pick?.total_score || 50)}`}>
 {(pick?.total_score || 0).toFixed(1)}
 </div>
 </td>
 <td className="px-4 py-4">
 <span className={`inline-block px-3 py-1 rounded-full text-xl font-medium ${getRatingColor(pick?.rating || 'HOLD')}`}>
 {pick?.rating || 'HOLD'}
 </span>
 </td>
 <td className="px-4 py-4">
 ...
 <span className={`text-lg px-2 py-1 rounded ${getRiskColor(pick?.risk_level || 'MODERATE')}`}>
 ...
 <p className="text-xl text-gray-300 mb-2">{pick?.explanation || 'Investment analysis pending...'}</p>
 <div className="flex flex-wrap gap-1 mb-2">
 <div className="text-lg text-green-400 font-medium">Strengths:</div>
 {(pick?.key_strengths || []).slice(0, 3).map((strength, idx) => (
 <span key={idx} className="text-lg bg-green-900 text-green-300 px-2 py-1 rounded">
 {strength}
 </span>
 ))}
 </div>
 ...
 <div className="flex flex-wrap gap-1">
 <div className="text-lg text-red-400 font-medium">Risks:</div>
 {(pick?.key_risks || []).slice(0, 2).map((risk, idx) => (
 <span key={idx} className="text-lg bg-red-900 text-red-300 px-2 py-1 rounded">
 {risk}
 </span>
 ))}
 </div>
 ...
 Showing <span className="font-medium text-blue-400">{Math.min(displayLimit, topPicks.length)}</span> of{' '}
 <span className="font-medium text-green-400">{topPicks.length}</span> recommendations
 ...
 className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:from-gray-600 disabled:to-gray-700 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2"
 >
 {loadingMore ? (
 <>
 ...
 className="bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2"
 >
 <ArrowDown size={16} />
 ...
 <span className="ml-auto text-xl text-gray-500">Real-time • TradeStation API</span>
 </h3>
 ...
 <div className="bg-gradient-to-br from-green-500 to-green-600 text-[rgb(252, 251, 255)] p-3 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-3xl font-medium">AAPL</div>
 <div className="text-2xl font-black">+2.45%</div>
 <div className="text-lg opacity-90">$3.2T</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '10px', left: '200px', width: '160px', height: '120px' }}>
 <div className="bg-gradient-to-br from-green-400 to-green-500 text-[rgb(252, 251, 255)] p-3 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-3xl font-medium">MSFT</div>
 <div className="text-2xl font-black">+1.87%</div>
 <div className="text-lg opacity-90">$2.8T</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '10px', left: '370px', width: '140px', height: '60px' }}>
 <div className="bg-gradient-to-br from-red-500 to-red-600 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">NVDA</div>
 <div className="text-3xl font-black">-3.21%</div>
 <div className="text-lg opacity-90">$850B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '80px', left: '370px', width: '140px', height: '50px' }}>
 <div className="bg-gradient-to-br from-green-300 to-green-400 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">GOOGL</div>
 <div className="text-md font-black">+0.95%</div>
 <div className="text-lg opacity-90">$1.7T</div>
 </div>
 </div>

 {/* Healthcare Sector */}
 <div className="absolute" style={{ top: '140px', left: '10px', width: '120px', height: '80px' }}>
 <div className="bg-gradient-to-br from-green-600 to-green-700 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">JNJ</div>
 <div className="text-3xl font-black">+2.84%</div>
 <div className="text-lg opacity-90">$420B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '140px', left: '140px', width: '100px', height: '80px' }}>
 <div className="bg-gradient-to-br from-green-400 to-green-500 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">UNH</div>
 <div className="text-md font-black">+1.95%</div>
 <div className="text-lg opacity-90">$520B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '140px', left: '250px', width: '80px', height: '50px' }}>
 <div className="bg-gradient-to-br from-red-400 to-red-500 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">PFE</div>
 <div className="text-xl font-black">-1.22%</div>
 <div className="text-lg opacity-90">$160B</div>
 </div>
 </div>

 {/* Financials */}
 <div className="absolute" style={{ top: '230px', left: '10px', width: '110px', height: '90px' }}>
 <div className="bg-gradient-to-br from-green-500 to-green-600 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">JPM</div>
 <div className="text-3xl font-black">+3.12%</div>
 <div className="text-lg opacity-90">$480B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '230px', left: '130px', width: '90px', height: '60px' }}>
 <div className="bg-gradient-to-br from-green-300 to-green-400 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">BAC</div>
 <div className="text-md font-black">+1.45%</div>
 <div className="text-lg opacity-90">$320B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '300px', left: '130px', width: '90px', height: '50px' }}>
 <div className="bg-gradient-to-br from-orange-400 to-orange-500 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">WFC</div>
 <div className="text-xl font-black">+0.31%</div>
 <div className="text-lg opacity-90">$180B</div>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-br from-red-500 to-red-600 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">AMZN</div>
 <div className="text-3xl font-black">-2.14%</div>
 <div className="text-lg opacity-90">$1.6T</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '310px', left: '230px', width: '100px', height: '60px' }}>
 <div className="bg-gradient-to-br from-red-600 to-red-700 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">TSLA</div>
 <div className="text-md font-black">-4.67%</div>
 <div className="text-lg opacity-90">$790B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '380px', left: '230px', width: '80px', height: '40px' }}>
 <div className="bg-gradient-to-br from-green-400 to-green-500 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">HD</div>
 <div className="text-xl font-black">+1.23%</div>
 <div className="text-lg opacity-90">$380B</div>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-br from-red-400 to-red-500 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">META</div>
 <div className="text-3xl font-black">-1.89%</div>
 <div className="text-lg opacity-90">$1.3T</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '220px', left: '370px', width: '90px', height: '50px' }}>
 <div className="bg-gradient-to-br from-green-300 to-green-400 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">NFLX</div>
 <div className="text-xl font-black">+0.78%</div>
 <div className="text-lg opacity-90">$220B</div>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-br from-red-600 to-red-700 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">XOM</div>
 <div className="text-3xl font-black">-3.45%</div>
 <div className="text-lg opacity-90">$410B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '360px', left: '120px', width: '80px', height: '50px' }}>
 <div className="bg-gradient-to-br from-red-500 to-red-600 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">CVX</div>
 <div className="text-xl font-black">-2.87%</div>
 <div className="text-lg opacity-90">$280B</div>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-br from-green-500 to-green-600 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">PG</div>
 ...
 <div className="bg-gradient-to-br from-green-400 to-green-500 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">KO</div>
 <div className="text-xl font-black">+1.67%</div>
 <div className="text-lg opacity-90">$290B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '440px', left: '190px', width: '60px', height: '40px' }}>
 <div className="bg-gradient-to-br from-orange-400 to-orange-500 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">WMT</div>
 <div className="text-lg font-black">+0.45%</div>
 <div className="text-lg opacity-90">$690B</div>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-br from-red-500 to-red-600 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-xl font-medium">BA</div>
 <div className="text-md font-black">-2.93%</div>
 <div className="text-lg opacity-90">$150B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '360px', left: '340px', width: '70px', height: '50px' }}>
 <div className="bg-gradient-to-br from-green-400 to-green-500 text-[rgb(252, 251, 255)] p-2 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">CAT</div>
 <div className="text-xl font-black">+1.12%</div>
 <div className="text-lg opacity-90">$170B</div>
 </div>
 </div>

 {/* Utilities & Materials - Smaller tiles */}
 <div className="absolute" style={{ top: '430px', left: '260px', width: '60px', height: '40px' }}>
 <div className="bg-gradient-to-br from-orange-300 to-orange-400 text-[rgb(252, 251, 255)] p-1 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">NEE</div>
 <div className="text-lg font-black">+0.23%</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '430px', left: '330px', width: '50px', height: '40px' }}>
 <div className="bg-gradient-to-br from-red-400 to-red-500 text-[rgb(252, 251, 255)] p-1 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">LIN</div>
 <div className="text-lg font-black">-1.56%</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '480px', left: '190px', width: '50px', height: '30px' }}>
 <div className="bg-gradient-to-br from-green-300 to-green-400 text-[rgb(252, 251, 255)] p-1 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">SO</div>
 <div className="text-lg font-black">+0.67%</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '480px', left: '250px', width: '45px', height: '30px' }}>
 <div className="bg-gradient-to-br from-orange-400 to-orange-500 text-[rgb(252, 251, 255)] p-1 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">FCX</div>
 <div className="text-lg font-black">+0.12%</div>
 </div>
 </div>

 {/* Real Estate - Small tiles */}
 <div className="absolute" style={{ top: '420px', left: '390px', width: '60px', height: '50px' }}>
 <div className="bg-gradient-to-br from-green-500 to-green-600 text-[rgb(252, 251, 255)] p-1 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">AMT</div>
 <div className="text-xl font-black">+1.89%</div>
 <div className="text-lg opacity-90">$95B</div>
 </div>
 </div>

 <div className="absolute" style={{ top: '480px', left: '390px', width: '50px', height: '30px' }}>
 <div className="bg-gradient-to-br from-orange-300 to-orange-400 text-[rgb(252, 251, 255)] p-1 rounded-lg shadow-lg h-full flex flex-col justify-center items-center hover:scale-105 transition-all cursor-pointer">
 <div className="text-lg font-medium">PLD</div>
 <div className="text-lg font-black">+0.34%</div>
 </div>
 </div>
 </div>
 ...
 <div className="text-green-800 font-medium text-2xl">67%</div>
 <div className="text-green-600 text-xl">Stocks Up</div>
 </div>
 <div className="bg-red-50 p-4 rounded-lg border border-red-200">
 <div className="text-red-800 font-medium text-2xl">33%</div>
 <div className="text-red-600 text-xl">Stocks Down</div>
 </div>
 <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
 <div className="text-blue-800 font-medium text-2xl">+0.85%</div>
 <div className="text-blue-600 text-xl">S&P 500</div>
 </div>
 <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
 <div className="text-purple-800 font-medium text-2xl">$42.3T</div>
 <div className="text-purple-600 text-xl">Total Market Cap</div>
 </div>
 </div>

 {/* Legend */}
 <div className="mt-6 p-4 bg-gray-50 rounded-lg">
 <h4 className="text-xl font-medium text-gray-700 mb-3">Market Heatmap Legend</h4>
 ...
 <div>
 <h4 className="text-3xl font-medium text-green-800">Conservative Strategy</h4>
 <p className="text-xl text-green-600">Age 50+ or Risk Averse</p>
 </div>
 </div>
 
 <div className="space-y-4">
 <div className="bg-green-50 p-4 rounded-lg">
 <h5 className="font-medium text-green-800 mb-3">Allocation Guidelines:</h5>
 <div className="space-y-2">
 <div className="flex justify-between items-center">
 <span className="text-green-700"> Low Risk</span>
 <span className="font-medium text-green-800">70%</span>
 </div>
 <div className="flex justify-between items-center">
 ...
 <span className="font-medium text-red-700">5%</span>
 </div>
 </div>
 </div>
 
 <div className="text-xl text-green-700 space-y-2">
 ...
 <div>
 <h4 className="text-3xl font-medium text-blue-800">Balanced Strategy</h4>
 <p className="text-xl text-blue-600">Age 30-50 or Moderate Risk</p>
 </div>
 </div>
 
 <div className="space-y-4">
 <div className="bg-blue-50 p-4 rounded-lg">
 <h5 className="font-medium text-blue-800 mb-3">Allocation Guidelines:</h5>
 <div className="space-y-2">
 <div className="flex justify-between items-center">
 <span className="text-green-700"> Low Risk</span>
 <span className="font-medium text-green-800">40%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-yellow-600"> Moderate Risk</span>
 <span className="font-medium text-yellow-700">40%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-red-600"> High Risk</span>
 ...
 <div className="text-xl text-blue-700 space-y-2">
 ...
 <div>
 <h4 className="text-3xl font-medium text-red-800">Aggressive Strategy</h4>
 <p className="text-xl text-red-600">Age &lt;30 or High Risk Tolerance</p>
 </div>
 </div>
 
 <div className="space-y-4">
 <div className="bg-red-50 p-4 rounded-lg">
 <h5 className="font-medium text-red-800 mb-3">Allocation Guidelines:</h5>
 <div className="space-y-2">
 <div className="flex justify-between items-center">
 <span className="text-green-700"> Low Risk</span>
 ...
 <div className="flex justify-between items-center">
 <span className="text-yellow-600"> Moderate Risk</span>
 <span className="font-medium text-yellow-700">30%</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-red-600"> High Risk</span>
 <span className="font-medium text-red-700">50%</span>
 </div>
 </div>
 </div>
 ...
 <div>
 <h5 className="font-medium text-purple-800 mb-3">Sector Diversification</h5>
 ...
 <div>
 <h5 className="font-medium text-purple-800 mb-3">Risk Management Rules</h5>
 ...
 <p className="text-xl text-gray-600">Optimize allocation percentages for target risk/return profile</p>
 </div>
 <div className="bg-white p-4 rounded-lg shadow-sm">
 ...
 <p className="text-lg mt-1">For balanced growth with manageable volatility</p>
 </div>
 ...
 <p className="text-lg mt-1">For aggressive growth with higher volatility</p>
 </div>
