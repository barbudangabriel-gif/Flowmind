...
const TradeStationMainPortfolio = () => {
 ...
 <h2 className="text-xl font-medium text-[rgb(252, 251, 255)] mb-2">Error Loading Portfolio</h2>
 ...
 <ChangeIcon size={24} />
 <span className="text-2xl font-medium">{portfolioData?.totalUnrealizedPnL >= 0 ? '+' : ''}{formatCurrency(Math.abs(portfolioData?.totalUnrealizedPnL || 0), 0)}</span>
 <span className="text-3xl">({portfolioData?.percentChange >= 0 ? '+' : ''}{(portfolioData?.percentChange || 0).toFixed(2)}%)</span>
 </div>
 ...
 <div className="text-xl text-gray-300">Positions: <span className="font-medium text-[rgb(252, 251, 255)]">{portfolioData?.totalPositions || 0}</span></div>
 ...
 <p className={`text-3xl font-medium ${portfolioData?.totalUnrealizedPnL >= 0 ? 'text-green-400' : 'text-red-400'}`}>{portfolioData?.totalUnrealizedPnL >= 0 ? '+' : ''}{formatCurrency(Math.abs(portfolioData?.totalUnrealizedPnL || 0), 0)}</p>
 </div>
