 ...
 * 
 * ⚠️ EXPERIMENTAL CHANNEL: congress_trades
 * 
    ...
    <div className="bg-gray-900 rounded-lg shadow-lg border border-gray-800 p-6">
      ...
      <div className="bg-blue-500/10 border border-blue-500/30 rounded p-3 mb-4">
        <p className="text-blue-400 text-xs">
          ℹ️ Congress trade filings are not real-time. Trades reported with 30-45 day delay.
        </p>
      </div>
      ...
      {error && (
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded p-3 mb-4">
          <p className="text-yellow-400 text-xs">
            ⚠️ WebSocket unavailable. Using REST API fallback (updates every 5 min)
          </p>
        </div>
      )}
