        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              <div className="text-gray-400 text-xs uppercase mb-1">Total GEX</div>
            ...
            {/* Call GEX */}
            <div className="bg-gray-800 rounded-lg p-4">
              <div className="text-gray-400 text-xs uppercase mb-1">Call GEX</div>
            ...
            {/* Put GEX */}
            <div className="bg-gray-800 rounded-lg p-4">
              <div className="text-gray-400 text-xs uppercase mb-1">Put GEX</div>
            ...
            {/* Zero Gamma Level */}
            <div className="bg-gray-800 rounded-lg p-4">
              <div className="text-gray-400 text-xs uppercase mb-1">Zero Gamma</div>
      ...
      <div className="mt-6 pt-4 border-t border-gray-800">
        ...
        <div className="space-y-1 max-h-32 overflow-y-auto">
          {messageHistory.slice(0, 10).map((msg, idx) => (
            <div
              key={idx}
              className="text-xs text-gray-500 font-mono flex items-center justify-between py-1"
            >
