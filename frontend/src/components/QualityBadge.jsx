...
export default function QualityBadge({ quality, delta, loading, className = "" }) {
 ...
 if (score >= 75) return "bg-emerald-500 text-[rgb(252, 251, 255)]";
 if (score >= 50) return "bg-amber-500 text-[rgb(252, 251, 255)]";
 return "bg-rose-500 text-[rgb(252, 251, 255)]";
 };
 ...
 {/* Main quality score */}
 <div 
 className={`px-2 py-1 rounded text-lg font-medium ${scoreColor}`} 
 title={tooltipText}
 >
...
export function QualityTooltip({ quality, children }) {
 ...
 {children}
 <div className="absolute z-50 invisible group-hover:visible bg-black text-[rgb(252, 251, 255)] text-lg rounded-lg p-3 -top-2 left-full ml-2 whitespace-nowrap">
 <div className="font-medium mb-2">Quality Breakdown (Score: {quality.score})</div>
