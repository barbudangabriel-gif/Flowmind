...
export default function PositionsTable({ mindfolioId }) {
 ...
 <div className="text-red-800 font-medium">Error loading positions</div>
 <div className="text-red-600">{error}</div>
 <button 
 onClick={loadData}
 className="mt-2 px-3 py-1 bg-red-600 text-[rgb(252, 251, 255)] rounded text-xl hover:bg-red-700"
 >
 Retry
 </button>
 </div>
 ...
 <h3 className="text-3xl font-medium text-gray-900">Current Positions (FIFO)</h3>
 ...
 <td colSpan="3" className="p-3 text-right font-medium text-gray-700">
 Total Cost Basis:
 </td>
 ...
 <div className="bg-white rounded-lg shadow-sm overflow-hidden">
 <div className="px-6 py-4 border-b border-gray-200">
 <h3 className="text-3xl font-medium text-gray-900">Realized P&L by Symbol</h3>
 <p className="text-xl text-gray-500 mt-1">
