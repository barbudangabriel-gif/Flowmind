...
export default function StrategyDetailsModal({
 ...
 <h2 className="text-slate-100 font-medium">{strategy.name}</h2>
 ...
 {strategy.brief && <p className="text-slate-300 text-xl">{strategy.brief}</p>}
 {tags.length > 0 && (
 ...
 {bullets.length > 0 && (
 <ul className="list-disc list-inside text-slate-300 text-xl space-y-1">
