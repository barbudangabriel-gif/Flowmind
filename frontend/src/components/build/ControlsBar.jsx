...
export default function ControlsBar({ 
 ...
 {/* Date Display */}
 <div className="text-lg text-slate-400 uppercase tracking-wide">
 Date: {expiryLabel}
 </div>
 ...
 {/* Range Control */}
 <div>
 <label className="block text-lg text-slate-400 uppercase tracking-wide mb-2">
 ...
 <div className="flex items-center gap-3">
 <span className="text-lg text-slate-500">0.5x</span>
 <input 
 type="range" 
 min="0.5" 
 max="3" 
 ...
 />
 <span className="text-lg text-slate-500">3.0x</span>
 </div>
 </div>
 </div>
 ...
 <button 
 key={m.key} 
 className={`px-3 py-1.5 rounded text-lg transition-colors ${
 mode === m.key 
 ...
 <button 
 className="px-3 py-1.5 rounded text-lg bg-slate-800 text-slate-300 hover:bg-slate-700 transition-colors"
 ...
 <div className="p-3">
 <div className="text-lg uppercase tracking-wide text-slate-400 mb-3">
 Chart Options
 </div>
 ...
 <div>
 <div className="text-xl text-slate-200">High Contrast</div>
 <div className="text-lg text-slate-400">Color-blind safe palette</div>
 </div>
 <div className="relative">
 <input
 type="checkbox"
 ...
 <label className="flex items-center justify-between py-2 cursor-pointer hover:bg-slate-700/50 rounded px-2 -mx-2">
 <div>
 <div className="text-xl text-slate-200">Show Probability</div>
 <div className="text-lg text-slate-400">Display probability bands</div>
 </div>
 <div className="relative">
 <input
 type="checkbox"
 ...
 <div className="text-lg uppercase tracking-wide text-slate-400 mb-2">
 Greeks
 </div>
