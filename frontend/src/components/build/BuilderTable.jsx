export default function BuilderTable({ 
 ...
 <h3 className="text-xl font-medium text-slate-200">{getHeaderLabel()}</h3>
 ...
 <tr>
 <th className="text-left px-4 py-2 text-lg text-slate-400 uppercase tracking-wide">
 Underlying Price
 </th>
 <th className="text-right px-4 py-2 text-lg text-slate-400 uppercase tracking-wide">
 {getHeaderLabel()}
 </th>
 </tr>
 </thead>
 ...
 return (
 <tr key={`sep-${i}`}>
 <td colSpan={2} className="px-4 py-2 text-center text-lg text-slate-500">
