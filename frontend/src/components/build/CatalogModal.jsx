...
export default function CatalogModal({ open, onOpenChange, symbol }) {
 ...
 <DialogTitle className="text-xl font-medium">Strategy Catalog • {symbol}</DialogTitle>
 ...
 <span className="text-lg text-zinc-400 py-2">Stance:</span>
 ...
 <div className="flex gap-1">
 <span className="text-lg text-zinc-400 py-2">Level:</span>
 ...
 <h3 className="text-3xl font-medium text-white">{levelName}</h3>
 <span className="text-lg text-zinc-400">({strategies.length} strategies)</span>
 </div>
 ...
 <div className="text-lg text-zinc-500">Try adjusting your filters or search terms</div>
 </div>
 )}
 </div>
 </div>
