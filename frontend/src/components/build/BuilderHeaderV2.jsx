  ...
  return (
    <div className="flex items-center justify-between py-3 border-b border-slate-800" data-testid="builder-header">
      ...
      <div className="flex items-center gap-4">
        ...
        {meta?.change && (
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className={`px-1.5 py-0.5 rounded text-xs ${priceColor} bg-current bg-opacity-10`}>
              {changePct}
            </span>
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Action Buttons */}
        <button 
          className="px-3 py-1.5 rounded bg-slate-700 text-slate-200 hover:bg-slate-600 transition-colors text-sm"
          onClick={onCatalog}
        >
          Catalog
        </button>
        ...
        <button 
          className={`px-4 py-1.5 rounded text-white font-medium transition-colors text-sm ${tradeColor}`}
          onClick={onTrade}
