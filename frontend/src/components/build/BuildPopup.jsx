    ...
    <div className="fixed inset-0 z-[70] bg-black/40 backdrop-blur-sm">
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
          <div className="text-lg font-semibold text-white">Build — Strategy Catalog</div>
          <button
            onClick={onClose}
            ...
            <div key={lvl}>
              ...
              {cols[lvl].map(([group, items]) => (
                <div key={group} className="mb-4">
                  <div className="text-sky-300 text-xs font-medium uppercase tracking-wide mb-2">
                    {group}
                  </div>
        ...
        <div className="border-t border-white/10 px-6 py-4 bg-slate-900/50">
          {!hover ? (
            <div className="text-white/60 text-sm flex items-center justify-center py-8">
              <div className="text-center">
                <div className="text-base mb-2">👆 Hover over a strategy above</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
              ...
              <div className="lg:col-span-3">
                <div className="flex items-center gap-3 mb-3">
                  <h3 className="text-white font-semibold text-lg">{hover.name}</h3>
                ...
                {hover.tags && hover.tags.length > 0 && (
                  <div className="flex flex-wrap gap-2 mb-4">
                    {hover.tags.slice(0, 6).map(tag => (
                      <span key={tag} className="px-2 py-1 rounded text-xs bg-white/10 border border-white/15 text-white/80">
                        {tag}
                      </span>
                    ))}
                  </div>
