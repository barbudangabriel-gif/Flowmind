...
const CreateNewView = () => {
 ...
 className={`py-4 px-2 font-medium text-3xl ${
 activeTab === 'add'
 ...
 {/* View Name */}
 <div className="mb-6">
 <label className="block text-gray-600 text-3xl mb-3">View name:</label>
 <input
 type="text"
 value={viewName}
 onChange={(e) => setViewName(e.target.value)}
 className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none text-3xl"
 />
 </div>

 {/* Filter */}
 <div className="mb-6">
 <label className="block text-gray-600 text-3xl mb-3">Filter:</label>
 ...
 className="w-full px-4 py-3 pr-12 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none text-3xl"
 />
 ...
 {/* Categories */}
 <div>
 <h3 className="text-3xl font-medium text-gray-600 mb-4">Category</h3>
 ...
 {/* Available Columns */}
 <div>
 <h3 className="text-3xl font-medium text-gray-600 mb-4">Available Columns</h3>
 ...
 <button
 onClick={handleDone}
 className="w-full bg-black text-[rgb(252, 251, 255)] text-xl font-medium py-4 rounded-lg hover:bg-gray-800 transition-colors"
 >
 Done
 </button>
 </div>
