...
export default function TradeDrawer({ row, open, onClose }) {
 ...
 <div className="text-slate-200 font-medium">{row.symbol} — Trade</div>
 ...
 <a
 href={builderLink}
 className="w-full inline-flex items-center justify-center rounded-lg bg-indigo-600 hover:bg-indigo-500 text-[rgb(252, 251, 255)] px-3 py-2"
 >
 Open in Builder
 </a>

 <button
 className={`w-full inline-flex items-center justify-center rounded-lg ${stanceColor} text-[rgb(252, 251, 255)] px-3 py-2`}
