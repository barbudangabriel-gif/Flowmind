...
const TokenRefreshTest = () => {
 ...
 return (
 <div className="max-w-4xl mx-auto p-6 bg-gray-900 text-[rgb(252, 251, 255)] rounded-lg">
 <h1 className="text-2xl font-medium mb-6"> TradeStation Token Refresh Test</h1>
 
 {/* Status Display */}
 <div className="bg-gray-800 p-4 rounded-lg mb-6">
 <h2 className="text-3xl font-medium mb-3">Current Status</h2>
 {status ? (
 ...
 {/* Logs */}
 <div className="bg-black rounded-lg p-4 h-64 overflow-y-auto font-mono text-xl">
