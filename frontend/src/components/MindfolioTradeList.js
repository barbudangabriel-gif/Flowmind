...
const MindfolioTradeList = () => {
 ...
 <button
 onClick={() => navigate(`/mindfolios/${mindfolioId}/charts`)}
 ...
 {currentMindfolio.name} Trade List
 </h1>
 ...
 <h2 className="text-3xl font-medium text-gray-900">Trade Filters</h2>
 </div>
...
export default MindfolioTradeList;