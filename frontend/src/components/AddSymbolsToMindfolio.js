...
const AddSymbolsToMindfolio = () => {
 ...
 navigate('/mindfolios/create/manual/quantities', { 
 ...
 Enter symbols separated by commas to add to your mindfolio.
 </p>
...
export default AddSymbolsToMindfolio;