...
const AllPortfolios = () => {
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-gray-400 text-xl">Total Portfolios</p>
 <p className="text-2xl font-medium text-[rgb(252, 251, 255)]">{aggregateStats.totalPortfolios}</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-gray-400 text-xl">Main Portfolio</p>
 <p className="text-3xl font-medium text-[rgb(252, 251, 255)]">{aggregateStats.activePortfolio}</p>
 ...
 <div>
 <h3 className="text-xl font-medium text-[rgb(252, 251, 255)]">{portfolio.name}</h3>
 <p className="text-gray-400 text-xl">{portfolio.positions_count} positions</p>
 </div>
 <div className={`px-3 py-1 rounded-full text-lg font-medium ${getRiskColor(portfolio.category)}`}>
 ...
 <div className="text-3xl font-medium text-[rgb(252, 251, 255)]">{portfolio.positions_count}</div>
 </div>
 <div className="text-center p-3 bg-gray-700 rounded-lg">
 ...
 <h3 className="text-3xl font-medium text-gray-300 mb-2">No portfolios found</h3>
