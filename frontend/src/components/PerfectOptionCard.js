    ...
    <div className="bg-gray-800 rounded-lg border border-gray-600 hover:border-blue-500 transition-colors duration-200 overflow-hidden" style={{width: '280px', height: '320px'}}>
      ...
      <div className="px-4 py-3 border-b border-gray-700">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="text-right">
            <div className="text-lg font-bold text-green-400">{returnOnRisk}</div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-lg font-bold text-blue-400">{chance}</div>
      ...
      <div className="px-4 py-3">
        <div className="bg-gray-900 rounded border border-gray-700 relative" style={{height: '140px'}}>
          ...
          <div className="absolute bottom-1 left-2 text-xs text-gray-500 font-mono">15</div>
          <div className="absolute bottom-1 right-2 text-xs text-gray-500 font-mono">35</div>
          <div className="absolute bottom-1 left-1/2 transform -translate-x-1/2 text-xs text-orange-400 font-semibold bg-gray-900 px-1">
            {currentPrice}
          </div>
          
          {/* P&L Labels */}
          <div className="absolute top-2 left-2 text-xs text-green-400 font-semibold bg-gray-900 px-1">
            {profit}
          </div>
          <div className="absolute top-2 right-2 text-xs text-red-400 font-semibold bg-gray-900 px-1">
            -{risk}
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-2 space-y-2">
        ...
        <div className="flex justify-between items-center text-sm">
          ...
          <span className="text-yellow-400 font-semibold">${breakeven}</span>
        </div>
      </div>

      {/* Button Section */}
      <div className="px-4 pb-3">
        <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded font-medium text-sm transition-colors">
          Open in Builder
        </button>
      </div>
    </div>
