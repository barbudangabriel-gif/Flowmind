...
const StrategyOptimizeCard = ({ 
 ...
 {/* Header Info */}
 <div className="mb-4">
 <div className="text-xl text-slate-400 font-medium mb-1">
 {strategy.action}
 </div>
 <div className="text-xl font-medium text-[rgb(252, 251, 255)]">
 {strategy.name}
 </div>
 </div>
 ...
 <div className="text-xl text-[rgb(252, 251, 255)]">
 Return on risk
 </div>
 </div>
 </div>
 ...
 <div className="text-lg text-[rgb(252, 251, 255)]">
 Chance
 </div>
 </div>
 ...
 <div className="bg-blue-600 text-[rgb(252, 251, 255)] text-lg px-2 py-1 rounded">
 ...
 {/* Chart labels */}
 <div className="absolute bottom-1 left-2 text-lg text-[rgb(252, 251, 255)]">
 {strategy.maxLoss}
 </div>
 <div className="absolute bottom-1 right-2 text-lg text-[rgb(252, 251, 255)]">
 {strategy.breakeven}
 </div>
 </div>
 ...
 className="w-full bg-slate-700 hover:bg-slate-600 text-[rgb(252, 251, 255)] font-medium py-3 px-4 rounded-lg transition-all duration-200 hover:shadow-lg border border-slate-600 hover:border-slate-500"
 >
 Open in Builder
 </button>
