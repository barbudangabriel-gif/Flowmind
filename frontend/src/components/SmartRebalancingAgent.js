...
const SmartRebalancingAgent = () => {
 ...
 {/* Header */}
 <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-[rgb(252, 251, 255)]">
 ...
 className={`flex items-center space-x-2 py-4 px-2 border-b-2 font-medium text-xl transition-colors ${
 activeTab === tab.id
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-green-600 text-xl font-medium">Diversification</p>
 <p className="text-2xl font-medium text-green-900">{analysisData?.diversification_score}/10</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-yellow-600 text-xl font-medium">Risk Score</p>
 <p className="text-2xl font-medium text-yellow-900">{analysisData?.risk_score}/10</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-purple-600 text-xl font-medium">Leverage</p>
 <p className="text-2xl font-medium text-purple-900">{analysisData?.leverage_ratio}x</p>
 </div>
 ...
 {/* Sector Allocation */}
 <div>
 <h3 className="text-3xl font-medium text-gray-900 mb-4">Sector Allocation</h3>
 ...
 <span className="text-xl font-medium text-gray-900 w-12">{percentage}%</span>
 </div>
 </div>
 ))}
 </div>
 ...
 {marketConditions && (
 <div>
 <h3 className="text-3xl font-medium text-gray-900 mb-4">Current Market Conditions</h3>
 <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
 <div className="bg-white p-3 rounded-lg border">
 <p className="text-lg text-gray-600">Sentiment</p>
 <p className="font-medium">{marketConditions.overall_sentiment}</p>
 </div>
 <div className="bg-white p-3 rounded-lg border">
 <p className="text-lg text-gray-600">VIX</p>
 <p className="font-medium">{marketConditions.vix}</p>
 </div>
 <div className="bg-white p-3 rounded-lg border">
 <p className="text-lg text-gray-600">Trend</p>
 <p className="font-medium">{marketConditions.market_trend}</p>
 </div>
 <div className="bg-white p-3 rounded-lg border">
 <p className="text-lg text-gray-600">Strategy</p>
 <p className="font-medium text-lg">{marketConditions.recommended_strategy}</p>
 </div>
 </div>
 </div>
 )}
 ...
 <div className="flex items-center justify-between">
 <h2 className="text-xl font-medium text-gray-900">AI Recommendations</h2>
 <span className="text-xl text-gray-600">{recommendations.length} recommendations</span>
 </div>
 ...
 <div className="flex items-center space-x-3">
 <span className={`px-2 py-1 rounded text-lg font-medium ${getPriorityColor(rec.priority)}`}>
 {rec.priority}
 </span>
 <span className="text-xl text-gray-600">{rec.type}</span>
 </div>
 <div className={`text-xl font-medium ${getConfidenceColor(rec.confidence)}`}>
 {(rec.confidence * 100).toFixed(0)}% confidence
 </div>
 </div>
 
 <h3 className="text-3xl font-medium text-gray-900 mb-2">{rec.action}</h3>
 ...
 <div className="space-y-6">
 <div>
 <h2 className="text-xl font-medium text-gray-900 mb-4">Smart Dollar-Cost Averaging</h2>
 <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
 <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg">
 <p className="text-green-600 text-xl font-medium">Active Opportunities</p>
 <p className="text-2xl font-medium text-green-900">{smartDCAData?.active_opportunities}</p>
 </div>
 <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg">
 <p className="text-blue-600 text-xl font-medium">Required Capital</p>
 <p className="text-2xl font-medium text-blue-900">${smartDCAData?.total_capital_required?.toLocaleString()}</p>
 </div>
 <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg">
 <p className="text-purple-600 text-xl font-medium">Expected Return</p>
 <p className="text-2xl font-medium text-purple-900">{((smartDCAData?.expected_return || 0) * 100).toFixed(1)}%</p>
 </div>
 <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 p-4 rounded-lg">
 <p className="text-yellow-600 text-xl font-medium">Risk Level</p>
 <p className="text-2xl font-medium text-yellow-900">{smartDCAData?.risk_level}</p>
 </div>
 </div>
 </div>

 <div>
 <h3 className="text-3xl font-medium text-gray-900 mb-4">DCA Opportunities</h3>
 <div className="space-y-4">
 {smartDCAData?.opportunities?.map((opp, index) => (
 <div key={index} className="bg-white border border-gray-200 rounded-lg p-6">
 <div className="flex items-center justify-between mb-4">
 <h4 className="text-3xl font-medium text-gray-900">{opp.symbol}</h4>
 <div className={`text-xl font-medium ${getConfidenceColor(opp.bottom_confidence)}`}>
 ...
 <div>
 <p className="text-xl font-medium text-gray-600 mb-2">Support Levels</p>
 <div className="space-y-1">
 {opp.support_levels?.map((level, idx) => (
 <div key={idx} className="text-xl bg-gray-50 px-2 py-1 rounded">
 ${level}
 </div>
 ))}
 </div>
 ...
 <div>
 <p className="text-xl font-medium text-gray-600 mb-2">Strategy</p>
 <p className="text-xl">{opp.allocation_strategy}</p>
 </div>
 
 <div>
 <p className="text-xl font-medium text-gray-600 mb-2">Timeline</p>
 <p className="text-xl">{opp.timeline}</p>
 </div>
 </div>
 
 <div>
 <p className="text-xl font-medium text-gray-600 mb-2">Technical Signals</p>
 <div className="flex flex-wrap gap-2">
 {opp.technical_signals?.map((signal, idx) => (
 <span key={idx} className="text-lg bg-blue-100 text-blue-800 px-2 py-1 rounded-full">
 {signal}
 </span>
 ))}
 </div>
 ...
 <div className="bg-white p-4 rounded-lg border">
 <p className="text-xl text-gray-600">Sharpe Ratio</p>
 <p className="text-2xl font-medium text-gray-900">{riskAnalysis?.sharpe_ratio}</p>
 </div>
 <div className="bg-white p-4 rounded-lg border">
 <p className="text-xl text-gray-600">Max Drawdown</p>
 <p className="text-2xl font-medium text-red-600">{((riskAnalysis?.max_drawdown || 0) * 100).toFixed(1)}%</p>
 </div>
 </div>
 </div>

 <div>
 <h3 className="text-3xl font-medium text-gray-900 mb-4">Risk Factors</h3>
 <div className="space-y-3">
 {riskAnalysis?.risk_factors?.map((factor, index) => (
 <div key={index} className="bg-white border border-gray-200 rounded-lg p-4">
 <div className="flex items-center justify-between mb-2">
 <h4 className="font-medium text-gray-900">{factor.factor}</h4>
 <span className={`px-2 py-1 rounded text-lg font-medium ${getPriorityColor(factor.level)}`}>
 {factor.level}
 </span>
 </div>
 <p className="text-gray-700 text-xl">{factor.impact}</p>
 </div>
 ))}
 </div>
 </div>
