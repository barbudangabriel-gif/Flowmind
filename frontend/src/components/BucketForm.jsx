...
export default function BucketForm({ portfolioId, onCreated }) {
 ...
 <div className="font-medium">Add Strategy Bucket</div>
 ...
 <div>
 <label className="block text-lg text-gray-500 mb-1">Bucket Name</label>
 <input 
 ...
 <div>
 <label className="block text-lg text-gray-500 mb-1">Start Budget</label>
 <input 
 className="w-full border rounded px-3 py-2" 
 type="number" 
 placeholder="100000" 
 ...
 <div>
 <label className="block text-lg text-gray-500 mb-1">Symbol Filter</label>
 <input 
 className="w-full border rounded px-3 py-2" 
 ...
 <div>
 <label className="block text-lg text-gray-500 mb-1">Trade Side</label>
 <select 
 className="w-full border rounded px-3 py-2" 
 value={side} 
 ...
 <div>
 <label className="block text-lg text-gray-500 mb-1">Option Type</label>
 <select 
 className="w-full border rounded px-3 py-2" 
 value={optType} 
 ...
 <button 
 className="bg-black text-[rgb(252, 251, 255)] px-4 py-2 rounded disabled:opacity-50 disabled:cursor-not-allowed"
