  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">Icon Preview (temporary)</h1>
          <p className="text-slate-400 text-sm">Alege iconul preferat pentru fiecare secțiune. Pagina este temporară și o voi elimina după selecție.</p>
        </div>

        <div className="space-y-8">
          {groups.map((group, idx) => (
            <div key={idx}>
              <div className="mb-3 text-slate-200 font-semibold">{group.title}</div>
