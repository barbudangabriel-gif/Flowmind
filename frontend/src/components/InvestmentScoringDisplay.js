...
const InvestmentScoringDisplay = () => {
 ...
 <TrendingUp className="w-8 h-8 text-[rgb(252, 251, 255)]" />
 </div>
 <div>
 <h1 className="text-3xl font-medium text-[rgb(252, 251, 255)]">Investment Scoring</h1>
 ...
 <h3 className="text-3xl font-medium text-[rgb(252, 251, 255)]">Status Scanner</h3>
 ...
 className="bg-blue-600 hover:bg-blue-700 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg flex items-center gap-2 transition-colors"
 >
 ...
 onClick={startScan}
 disabled={scanning}
 className="bg-green-600 hover:bg-green-700 disabled:bg-gray-600 text-[rgb(252, 251, 255)] px-4 py-2 rounded-lg flex items-center gap-2 transition-colors"
 >
 ...
 <div className={`font-medium ${scannerStatus.status === 'completed' ? 'text-green-400' : 'text-yellow-400'}`}>
 ...
 <div className="bg-gray-700 rounded-lg p-4">
 <div className="text-xl text-gray-400">Total Acțiuni</div>
 <div className="text-2xl font-medium text-[rgb(252, 251, 255)]">{scannerStatus.total_stocks_scanned || 0}</div>
 </div>
 <div className="bg-gray-700 rounded-lg p-4">
 <div className="text-xl text-gray-400">Ultima Scanare</div>
 <div className="text-[rgb(252, 251, 255)]">
 ...
 <div className="bg-gray-700 rounded-lg p-4">
 <div className="text-xl text-gray-400">Database</div>
 <div className={`font-medium ${scannerStatus.database_status === 'active' ? 'text-green-400' : 'text-red-400'}`}>
 ...
 <div className="mt-4">
 <div className="text-xl text-gray-400 mb-2">Top 5 Acțiuni:</div>
 ...
 <span className="text-[rgb(252, 251, 255)] font-medium">{stock.ticker}</span>
 <span className={`text-xl ${getScoreColor(stock.score)}`}>
 {stock.score}
 </span>
 </div>
 ))}
 ...
 className="bg-gray-700 text-[rgb(252, 251, 255)] pl-10 pr-4 py-2 rounded-lg border border-gray-600 focus:border-blue-500 focus:outline-none w-64"
 />
 </div>
 ...
 className="bg-gray-700 text-[rgb(252, 251, 255)] px-3 py-2 rounded-lg border border-gray-600 focus:border-blue-500 focus:outline-none"
 >
 ...
 <tr>
 <th className="text-left px-6 py-4 text-gray-300 font-medium">Rank</th>
 <th className="text-left px-6 py-4 text-gray-300 font-medium">Ticker</th>
 <th className="text-left px-6 py-4 text-gray-300 font-medium">Scor</th>
 <th className="text-left px-6 py-4 text-gray-300 font-medium">Rating</th>
 <th className="text-left px-6 py-4 text-gray-300 font-medium">Preț</th>
 <th className="text-left px-6 py-4 text-gray-300 font-medium">Sector</th>
 <th className="text-left px-6 py-4 text-gray-300 font-medium">Explicație</th>
 </tr>
 </thead>
 ...
 <div className="flex items-center gap-2">
 <span className="bg-blue-600 text-[rgb(252, 251, 255)] px-2 py-1 rounded text-xl font-medium">
 #{index + 1}
 </span>
 </div>
 </td>
 ...
 className="font-medium text-blue-400 hover:text-blue-300 text-3xl transition-colors duration-200 flex items-center gap-2 group-hover:gap-3"
 ...
 <td className="px-6 py-4">
 <div className={`text-xl font-medium ${getScoreColor(stock.score)}`}>
 {stock.score}
 </div>
 </td>
 <td className="px-6 py-4">
 ...
 <td className="px-6 py-4">
 <div className="text-gray-400 text-xl max-w-xs truncate">
 {stock.explanation}
 </div>
 </td>
 </tr>
 ...
 <h3 className="text-xl font-medium text-gray-300 mb-2">Nu există date</h3>
 ...
 onClick={startScan}
 disabled={scanning}
 className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 text-[rgb(252, 251, 255)] px-6 py-3 rounded-lg flex items-center gap-2 mx-auto transition-colors"
 >
