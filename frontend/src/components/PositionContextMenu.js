...
const PositionContextMenu = ({ 
 ...
 <span className="text-lg text-gray-600">{position.quantity} shares</span>
 </div>
 <div className="flex items-center justify-between mt-1">
 <span className="text-xl text-gray-600">${position.current_price?.toFixed(2)}</span>
 <span className={`text-xl font-medium ${getPnLColor(position.unrealized_pnl)}`}>
