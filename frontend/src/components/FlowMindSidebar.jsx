...
export default function FlowMindSidebar({ ctx }) {
  ...
  return (
    <aside className="w-64 border-r bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-screen overflow-y-auto">
      {/* Brand */}
      <div className="px-3 py-3 border-b">
        <div className="text-lg font-semibold">FlowMind</div>
