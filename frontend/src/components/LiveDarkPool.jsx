...
const LiveDarkPool = ({ maxItems = 50, className = '' }) => {
 ...
 <h3 className="text-3xl font-medium text-[rgb(252, 251, 255)]">🕶️ Dark Pool</h3>
 ...
 <div className="text-lg mt-1">Institutional block trades will appear here</div>
 </div>
 </div>
 ) : (
 trades.map((trade) => (
 ...
 className="text-xl font-medium text-purple-400 hover:text-purple-300 hover:underline w-16 flex-shrink-0"
 >
 {trade.symbol}
 </button>
 ...
 {/* Value */}
 <div className="text-xl font-medium text-purple-400 ml-auto flex-shrink-0">
 {formatValue(trade.value)}
 </div>

 {/* Exchange */}
 {trade.exchange && (
 <div className="text-lg px-2 py-0.5 rounded bg-slate-700 text-gray-300 flex-shrink-0">
 {trade.exchange}
 </div>
 )}
 ...
 {trade.value >= 1000000 && (
 <div className="text-lg px-2 py-0.5 rounded bg-purple-500/20 text-purple-400 font-medium flex-shrink-0">
 🐋 WHALE
 </div>
 )}
 </div>
