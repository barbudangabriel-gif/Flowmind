      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {BUILD_STRATEGIES.map(section => (
          <div key={section.level}>
            <div className="text-sm font-semibold mb-2 text-gray-700">{section.level}</div>
                ...
                <div key={group.title}>
                  ...
                  <div className="flex flex-col">
                    {group.items.map(name => (
                      <button
                        key={name}
                        className="text-left py-1 text-sm text-gray-700 hover:text-blue-600 hover:underline"
