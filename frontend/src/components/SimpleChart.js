  ...
  return (
    <div className="w-full h-full min-h-[600px] p-4 bg-neutral-900/40">
      ...
      <div className="mt-6 bg-neutral-800 rounded-lg border border-neutral-600 p-4">
        <h3 className="text-lg font-semibold text-white mb-3">Sample Data (Last 7 days)</h3>
            ...
            <tbody>
              {sampleData.slice(-7).map((row, index) => (
                <tr key={index} className="border-b border-neutral-700">
                  ...
                  <td className="p-2 text-right text-white font-mono">${row.price}</td>
      ...
      <div className="mt-6 bg-blue-900/20 border border-blue-700 rounded-lg p-4">
        <h3 className="text-lg font-semibold text-blue-300 mb-2">📊 Chart Integration Guide</h3>
