    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl relative">
        ...
        <div className="flex items-center justify-between p-8 pb-4">
          <h1 className="text-3xl font-bold text-gray-800">Create Portfolio</h1>
          <button
        ...
        <div className="px-8 pb-8">
          ...
          <button
            ...
            className="w-full bg-black text-white text-xl font-semibold py-4 rounded-xl hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-8 flex items-center justify-center"
          >
            {isCreating ? (
              <>
          ...
          {selectedMethod && (
            <div className="mt-6 flex space-x-4">
              ...
              <button
                ...
                className="flex-1 py-3 px-6 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors font-semibold"
              >
                Continue
              </button>
            </div>
