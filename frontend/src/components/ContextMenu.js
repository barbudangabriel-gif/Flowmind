...
const ContextMenu = ({ 
 ...
 <span className="text-xl text-gray-500">View Details</span>
 </div>
 <div className="px-4 py-2 hover:bg-gray-50 cursor-pointer">
 <span className="text-xl text-gray-500">Add Notes</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="text-xl text-gray-700">Moving position...</span>
 </div>
 </div>
 </div>
 )}
