...
2024-02-01T10:00:00Z,MSFT,BUY,75,410.80,2.25,USD,Tech diversification`;
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Import Transactions from CSV</h3>
      ...
      {result && (
        <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-md">
          <div className="text-green-800 font-semibold">Import Successful!</div>
      ...
      {error && (
        <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-md">
          <div className="text-red-800 font-semibold">Import Failed</div>
      ...
      <div className="border-t border-gray-200 pt-4">
        <h4 className="text-sm font-semibold text-gray-700 mb-2">CSV Format Requirements:</h4>
