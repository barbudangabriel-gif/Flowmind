...
export default function AnalyticsPanel({ portfolioId }) {
 ...
 <div>
 <div className="flex items-center justify-between mb-4">
 <h3 className="font-medium text-3xl">EOD Total (R+UR) — Europe/Bucharest</h3>
 <div className="flex items-center gap-4">
 <button
 onClick={snapNow}
 disabled={snapBusy}
 className="px-3 py-1.5 text-xl bg-emerald-600 text-[rgb(252, 251, 255)] rounded hover:bg-emerald-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
 >
 ...
 <div className={`px-2 py-0.5 rounded text-xl ${util >= 0.8 ? 'bg-rose-100 text-rose-700' : util >= 0.5 ? 'bg-amber-100 text-amber-700' : 'bg-emerald-100 text-emerald-700'}`}>
 ...
 <div className={`font-mono font-medium ${utilizationColor}`}>
