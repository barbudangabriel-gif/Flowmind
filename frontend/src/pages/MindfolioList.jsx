...
export default function MindfolioList() {
 ...
 className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg font-semibold transition-all hover:scale-105 shadow-lg flex items-center gap-2"
 >
 ...
 console.log('Creating mindfolio with template data:', templateData);
 await mfClient.create({
 name: templateData.name,
 starting_balance: templateData.starting_balance,
