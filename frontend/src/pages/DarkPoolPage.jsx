...
const DarkPoolPage = () => {
 ...
 setPrints([
 { ticker: 'TSLA', volume: 250000, price: 250.50, timestamp: new Date().toISOString(), exchange: 'DARK' },
 { ticker: 'NVDA', volume: 180000, price: 485.25, timestamp: new Date().toISOString(), exchange: 'DARK' },
 { ticker: 'AAPL', volume: 320000, price: 178.30, timestamp: new Date().toISOString(), exchange: 'DARK' }
 ]);
 } finally {
 setLoading(false);
 }
