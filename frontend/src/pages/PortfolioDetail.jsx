...
export default function PortfolioDetail() {
 ...
 <div className={`text-lg font-bold ${(stats.pnl_realized || 0) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
 ...
 <div>
 <div className="text-sm font-semibold text-white">Module Allocations</div>
 ...
 <div className="flex items-center gap-3 mb-5">
 <div>
 <div className="text-sm font-semibold text-white">Manage Funds</div>
