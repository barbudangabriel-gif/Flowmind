...
const InstitutionalPage = () => {
 ...
 setData({
 ticker: ticker,
 total_ownership_pct: 65.5,
 change_qoq: 2.3,
 top_holder: 'Vanguard Group',
 holdings: [
 { institution: 'Vanguard Group', shares: 50000000, value: 12500000000, pct_change: 1.5 },
 { institution: 'BlackRock', shares: 45000000, value: 11250000000, pct_change: -0.8 },
 { institution: 'State Street', shares: 30000000, value: 7500000000, pct_change: 3.2 }
 ]
 });
 } finally {
 setLoading(false);
 ...
 <div className={`text-xl font-bold ${data.change_qoq_pct > 0 ? 'text-emerald-400' : 'text-red-400'}`}>
