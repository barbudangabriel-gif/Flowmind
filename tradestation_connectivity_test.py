...
class TradeStationConnectivityTester:
    def __init__(self):
        ...
        self.base_url = "https://stockflow-ui.preview.emergentagent.com"
    ...
    def test_frontend_backend_url_configuration(self):
        ...
        expected_url = "https://stockflow-ui.preview.emergentagent.com"
    ...
    def run_connectivity_test(self):
        ...
        if not config_ok:
            ...
            print("   - Change from: https://stockflow-ui.preview.emergentagent.com")
            print("   - Change to: https://stockflow-ui.preview.emergentagent.com")
