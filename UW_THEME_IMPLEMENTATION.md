...
### **What's Still Old:**
- ⚠️ AppContent pages (inside main) - still use slate colors
- ⚠️ Cards/components - need UW card styling
- ⚠️ Tables - need UW table styling
- ⚠️ Forms - need UW input styling
- ⚠️ Charts - need UW chart colors
